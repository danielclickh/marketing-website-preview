...
export default function VideoSquare(props: HtmlHTMLAttributes<HTMLOrSVGElement>) {
  return (
    <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="1" y="1" width="70" height="70" rx="16" stroke="currentColor" strokeWidth="2" />
      <path fillRule="evenodd" clipRule="evenodd"
            ...
            stroke="currentColor" strokeWidth="2.63" strokeLinecap="round" strokeLinejoin="round" />
      <path
