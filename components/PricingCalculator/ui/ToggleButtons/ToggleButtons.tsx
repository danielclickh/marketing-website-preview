  ...
  return (
    <div className='flex gap-5'>
      {options.map((option, index) => (
        <div
          key={index}
          className={`flex gap-2 rounded-[4px] bg-neutral-750 py-2 px-10 text-sm font-medium transition-all  hover:cursor-pointer  hover:bg-neutral-725 hover:bg-opacity-80 hover:shadow-xl ${
            value === option.value
