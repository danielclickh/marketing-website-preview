      ...
      <div className='flex gap-3'>
        {plans.map((item, index) => {
          ...
          return (
            <button
              key={index}
              className={`block flex-1 rounded-[4px] border border-neutral-700 bg-neutral-750 px-3 py-2 text-center text-sm shadow-input transition-colors focus:outline-none ${
                isActive
                  ? 'border-primary'
