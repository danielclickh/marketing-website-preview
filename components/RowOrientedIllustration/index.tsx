...
function RowOrientedIllustration({ className }: Props): JSX.Element {
  return (
    <svg width="515" height="250" viewBox="0 0 515 250" fill="none" className={className}>
      ...
      <rect x="330.37" y="87.932" width="42.9384" height="0" rx="2" fill="#FF7575">
        <animate dur="200ms" fill="freeze" attributeName="height" begin="lineNav.begin+200ms" to="17" />
        <animate dur="0.5s" fill="freeze" attributeName="height" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="width" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="x" begin="lineNav.end+0.5s" to="425" />
      ...
      <rect x="36.7914" y="107.932" width="42.9384" height="0" rx="2" fill="#FF7575">
        <animate dur="200ms" fill="freeze" attributeName="height" begin="lineNav.begin+400ms" to="17" />
        <animate dur="0.5s" fill="freeze" attributeName="height" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="width" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="x" begin="lineNav.end+0.5s" to="425" />
      ...
      <rect x="183.581" y="107.932" width="42.9384" height="0" rx="2" fill="#FF7575">
        <animate dur="200ms" fill="freeze" attributeName="height" begin="lineNav.begin+400ms" to="17" />
        <animate dur="0.5s" fill="freeze" attributeName="height" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="width" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="x" begin="lineNav.end+0.5s" to="425" />
      ...
      <rect x="330.37" y="107.932" width="42.9384" height="0" rx="2" fill="#FF7575">
        <animate dur="200ms" fill="freeze" attributeName="height" begin="lineNav.begin+400ms" to="17" />
        <animate dur="0.5s" fill="freeze" attributeName="height" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="width" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="x" begin="lineNav.end+0.5s" to="425" />
      ...
      <rect x="36.7914" y="167.932" width="42.9384" height="0" rx="2" fill="#FF7575">
        <animate dur="200ms" fill="freeze" attributeName="height" begin="lineNav.begin+1000ms" to="17" />
        <animate dur="0.5s" fill="freeze" attributeName="height" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="width" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="x" begin="lineNav.end+0.5s" to="425" />
      ...
      <rect x="183.581" y="167.932" width="42.9384" height="0" rx="2" fill="#FF7575">
        <animate dur="200ms" fill="freeze" attributeName="height" begin="lineNav.begin+1000ms" to="17" />
        <animate dur="0.5s" fill="freeze" attributeName="height" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="width" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="x" begin="lineNav.end+0.5s" to="425" />
      ...
      <rect x="330.37" y="167.932" width="42.9384" height="0" rx="2" fill="#FF7575">
        <animate dur="200ms" fill="freeze" attributeName="height" begin="lineNav.begin+1000ms" to="17" />
        <animate dur="0.5s" fill="freeze" attributeName="height" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="width" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="x" begin="lineNav.end+0.5s" to="425" />
      ...
      <rect x="36.7914" y="187.932" width="42.9384" height="0" rx="2" fill="#FF7575">
        <animate dur="200ms" fill="freeze" attributeName="height" begin="lineNav.begin+1200ms" to="17" />
        <animate dur="0.5s" fill="freeze" attributeName="height" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="width" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="x" begin="lineNav.end+0.5s" to="425" />
      ...
      <rect x="183.581" y="187.932" width="42.9384" height="0" rx="2" fill="#FF7575">
        <animate dur="200ms" fill="freeze" attributeName="height" begin="lineNav.begin+1200ms" to="17" />
        <animate dur="0.5s" fill="freeze" attributeName="height" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="width" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="x" begin="lineNav.end+0.5s" to="425" />
      ...
      <rect x="330.37" y="187.932" width="42.9384" height="0" rx="2" fill="#FF7575">
        <animate dur="200ms" fill="freeze" attributeName="height" begin="lineNav.begin+1200ms" to="17" />
        <animate dur="0.5s" fill="freeze" attributeName="height" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="width" begin="lineNav.end+0.5s" to="0" />
        <animate dur="0.5s" attributeName="x" begin="lineNav.end+0.5s" to="425" />
      ...
      <rect id="line8" x="36.7914" y="207.932" width="42.9384" height="17" rx="2" fill="#282828" />
      <rect x="85.7211" y="207.932" width="42.9384" height="17" rx="2" fill="#282828" />
      <rect x="134.651" y="207.932" width="42.9384" height="17" rx="2" fill="#282828" />
      <rect x="183.581" y="207.932" width="42.9384" height="17" rx="2" fill="#282828" />
      <rect x="232.51" y="207.932" width="42.9384" height="17" rx="2" fill="#282828" />
      <rect x="281.44" y="207.932" width="42.9384" height="17" rx="2" fill="#282828" />
      <rect x="330.37" y="207.932" width="42.9384" height="17" rx="2" fill="#282828" />
      ...
      <g opacity="0">
        ...
        <animate id="barChart" attributeName="opacity" attributeType="XML" dur="1s" values="1; 1; 0"
          keyTimes="0; 0.99; 1" begin="2.417s;lineChart.end+2.417s" />
      </g>

      <g opacity="0" transform="matrix(1, 0, 0, 1, 412.135132, 89.503609)">
        <circle cx="49.2523" cy="48.932" r="38.5" fill="#FF7575" stroke="#FCFF74" stroke-width="21" />
        ...
        <animate id="pieChart" attributeName="opacity" attributeType="XML" dur="1s" values="1; 1; 0"
          keyTimes="0; 0.99; 1" begin="barChart.end+2.417s" />
      </g>

      <g opacity="0" transform="matrix(1, 0, 0, 1, 413.511292, 87.500008)">
        <path d="M0 36.3714L18.8 23L29.2 41L48 32.2571L70 41L98 26.6" stroke="#FCFF74" stroke-width="5" />
        <path d="M0 70.3714L18.8 57L29.2 75L48 66.2571L70 75L98 60.6" stroke="#FF7575" stroke-width="5" />
        <animate id="lineChart" attributeName="opacity" attributeType="XML" dur="1s" values="1; 1; 0"
          keyTimes="0; 0.99; 1" begin="pieChart.end+2.417s" />
      </g>
      <rect x="36.7914" y="67.932" width="336.517" height="2" rx="2" fill="#FF7575">
        <animate id="lineNav" attributeName="y" attributeType="XML" dur="1570ms" to="223.932"
          begin="0s;barChart.end;lineChart.end;pieChart.end" />
        <animate attributeName="opacity" attributeType="XML" dur="1s" values="0; 0; 1"
          keyTimes="0; 0.99; 1" begin="lineNav.end" />
      </rect>
    </svg>
  )
}
