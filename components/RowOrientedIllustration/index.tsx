...
function RowOrientedIllustration({ className }: Props): JSX.Element {
  return (
    <svg width="fill" height="fill" viewBox="0 0 556 269" fill="none" className={className}>
      ...
      <g opacity="0" transform="matrix(1, 0, 0, 1, 412.135132, 89.503609)">
        <circle cx="49.2523" cy="48.932" r="38.5" fill="#FF7575" stroke="#FCFF74" strokeWidth="21" />
