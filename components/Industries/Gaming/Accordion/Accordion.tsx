    ...
    <div className='rounded-xl border border-neutral-700/80 bg-neutral-900/50 p-6'>
      <div className='flex w-full flex-col items-center pt-6'>
        ...
        <p className='mx-auto mb-10 max-w-4xl px-9 pt-6 text-center'>
          ClickHouse is purpose-built for powering real-time analytics at
          massive scale. Track in-game events, ad performance, or player
          behavior with instant insights and low latency—all while keeping
        ...
        <p className='mx-auto mb-12 max-w-3xl px-9 text-center'>
          ...
          and column-oriented design ensure that even the most demanding gaming
          workloads run effortlessly at scale.
        </p>
      </div>
...
export default GamingAccordionComponent
