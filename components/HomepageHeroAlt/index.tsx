  ...
  return (
    <div className='relative overflow-x-hidden border-primary-300 lg:border-t-[38px]'>
      ...
      <div className='section-container relative z-20 grid lg:grid-cols-2'>
        {/* Text column */}
        <div className='relative z-30 order-last rounded-br-2xl bg-primary-300 pb-12 text-black md:pb-24 lg:order-first lg:rounded-br-none lg:py-24 xl:py-32'>
          <SuiTitle type='h1' className='md:!text-[2.85rem] xl:!text-[3.85rem]'>
            The{' '}
