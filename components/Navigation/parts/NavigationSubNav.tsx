...
export default function NavigationSubNav({
  ...
  return (
    <ul
      className={`h-auto w-full px-4 text-white transition-all md-mid:absolute md-mid:left-full md-mid:top-0 md-mid:-ml-4 md-mid:min-h-full md-mid:w-auto md-mid:min-w-full md-mid:rounded-lg md-mid:bg-neutral-750 md-mid:py-4 ${
        isOpen
