          ...
          <>
            <div className='mt-1 relative'>
              ...
              <Transition
                ...
                leaveTo='opacity-0'>
                <Listbox.Options className='absolute z-10 mt-1 w-full bg-light-grey1 dark:bg-dark-grey4 shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm max-w-lg'>
                  {props.options.map((option) => (
                    <Listbox.Option
                      ...
                      className={({ active }) =>
                        classNames(
                          active
                            ? 'text-text-darkest dark:text-text-lightest bg-light-grey2 dark:bg-dark-grey3'
