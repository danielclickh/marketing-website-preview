          ...
          <>
            <div className='mt-1 relative'>
              ...
              <Transition
                ...
                leaveTo='opacity-0'>
                <Listbox.Options className='absolute z-10 mt-1 w-full bg-c1 shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm max-w-lg'>
