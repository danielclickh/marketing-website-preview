    ...
    <div className='rounded-xl border border-neutral-700/80 bg-neutral-900/50 p-6'>
      <div className='flex w-full flex-col items-center pt-6'>
        ...
        <p className='mx-auto mb-12 max-w-3xl px-9 pt-6 text-center'>
          When it comes to SQL-based observability, ClickHouse shines in its
          ability to perform a huge range of analytical functions over massive
          volumes of data - leveraging features like high compression rates to
