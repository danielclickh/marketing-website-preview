...
**Prerequisites:** You will be running a Docker image that includes ClickHouse 21.10 and a sample dataset already indexed that contains streaming details from Spotify, so you will need **Docker** installed if you want to follow along.
...
We have built a Docker image that already has ClickHouse 21.10 installed, along with a table that contains the Spotify data: 
