...
1. materialized_postgresql_tables_list
...
2. materialized_postgresql_schema

Default value: empty string. (Default schema is used)

3. materialized_postgresql_schema_list

Default value: empty list. (Default schema is used)

4. materialized_postgresql_allow_automatic_update
...
5. materialized_postgresql_max_block_size
