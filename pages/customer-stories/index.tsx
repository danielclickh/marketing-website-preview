    ...
    <BaseLayout title='ClickHouse Cloud'>
          ...
          <div
            ...
            <div className='max-w-2xl'>
              <SuiText size='lg' color='dark' weight='normal'>
                <p>
                  Discover how users find success with ClickHouse as their
                  ultra-fast solution for generating analytics.
                </p>
              </SuiText>
            </div>
          </div>
      ...
      <div className='bg-web-light-c2 dark:bg-web-dark-c2 w-full pt-16 pb-24'>
        <div className='flex container mx-auto flex-col max-w-7xl px-6 2xl:px-0'>
          <SuiTitle size='lg'>
            <h2>Company use cases</h2>
          </SuiTitle>
          <SuiText size='lg' color='dark'>
            <p>
              ClickHouse is trusted for use at scale in big companies, find out
              why by reading some of our use cases.
            </p>
          </SuiText>
        </div>
