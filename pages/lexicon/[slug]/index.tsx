          ...
          <div className='flex-row items-start gap-16 lg:flex'>
            <div className="flex-shrink flex-grow">
              <h4 className="text-base font-semibold">
                <Link href="/lexicon" className='text-primary-300'>Lexicon</Link> / <strong>{lexicon.title}</strong>
              </h4>
              <SuiTitle type="h1" className="my-6 md:!text-5xl text-balance">
                {lexicon.title}
              </SuiTitle>
            ...
            <aside className="w-full flex-shrink-0 flex-grow-0 align-top lg:sticky lg:top-32 lg:max-w-sm">
              {moreLikeThis.length > 0 && (
                <div className="mb-8 ">
                  ...
                  {(moreLikeThis as LexiconPageProps['moreLikeThis']).map((item) => (
                    <Link href={item.link} className='mb-4 block w-full' key={item.link}>
                      <SuiButton
                        type='empty'
                        color='primary'
