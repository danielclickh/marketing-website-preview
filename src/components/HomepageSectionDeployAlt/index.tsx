    ...
    <div
      ...
      <div className='mb-16 flex justify-center'>
        <div className='flex max-w-[650px] flex-col items-center gap-4 text-center'>
          ...
          <SuiText size='lg'>
            Unlike traditional closed-source databases, ClickHouse runs in every
            environment, whether it’s on your machine or in the cloud.
          </SuiText>
        </div>
      </div>
      ...
      <div className='section-container'>
        <div className='mx-auto grid w-full max-w-[800px] grid-cols-1 gap-6 md:grid-cols-2'>
          ...
          <Link
            ...
            <SuiText>
              The best way to use ClickHouse. Available on AWS, GCP, Azure and,
          ...
          <Link
            ...
            <SuiText>
              Run fast queries on local files (CSV, TSV, Parquet, and many more)
              without a server.
            </SuiText>
            <span className='block w-full rounded border border-primary-600 py-2 text-center transition-colors group-hover:border-primary-500 group-hover:bg-white/5'>
