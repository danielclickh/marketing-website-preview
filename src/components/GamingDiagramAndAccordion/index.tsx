        ...
        <AccordionItem
          ...
          <div className='space-y-4 text-sm text-white/80'>
            ...
            <p>
              ...
              <Link
                href='https://clickhouse.com/docs/engines/table-engines/mergetree-family'
                className='text-primary-300 hover:underline'>
                table engines
              </Link>{' '}
            ...
            <p>
              ...
              <Link
                href='https://clickhouse.com/docs/optimize/asynchronous-inserts'
                className='text-primary-300 hover:underline'>
        ...
        <AccordionItem
          ...
          <div className='space-y-4 text-sm text-white/80'>
            <p>
              ...
              <Link
                href='https://clickhouse.com/docs/guides/developer/cascading-materialized-views'
                className='text-primary-300 hover:underline'>
                Materialized Views
              </Link>{' '}
