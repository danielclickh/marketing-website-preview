...
function CloudProviders({
  ...
  return (
    <div className='flex justify-center space-x-2 pb-6 pt-4 md:justify-start'>
            ...
            {cloudProvider.darkProviderPngs.map((darkIconPng, index) => (
              <div
                ...
                className={`relative w-auto px-4 ${
                  (parentIndex === 0 && path !== '/jp/cloud') ||
                  (index === 0 && path !== '/jp/cloud')
                ...
                {darkIconPng.name === 'logo_aws_dark.svg' ? (
                  <Link href='/jp/pricing?provider=aws'>
                    <StrapiImage
                  ...
                  <Link href='/jp/pricing?provider=gcp'>
                    <StrapiImage
                      key={`${cloudProvider.title}-${index}`}
                      {...darkIconPng}
                  ...
                  <Link href='/jp/pricing?provider=azure'>
                    <StrapiImage
                      key={`${cloudProvider.title}-${index}`}
                      {...darkIconPng}
                      className={'h-10 w-auto'}
