        ...
        <div className='relative flex flex-col gap-8 overflow-clip rounded bg-neutral-750 p-8 lg:p-16'>
          ...
          <div className='flex justify-center'>
            <div className='max-w-[600px] text-center'>
              ...
              <SuiText size='lg' className='opacity-70'>
                ClickHouseは非常に高速でリソース効率の高いリアルタイムデータウェアハウスであり、オープンソースのデータベースです。
              </SuiText>
            </div>
          </div>
          ...
          <div className='grid grid-cols-1 gap-12 lg:grid-cols-3'>
            <PerkCard
              ...
              title='驚きの速さ'
              text='究極のクエリパフォーマンス。ミッションクリティカルで遅延の許されないアプリケーションにも安心してお使いいただけます。'
            />
            <PerkCard
              icon={
                <svg
              ...
              title='開発が容易'
              text='最も高度なデータ分析でも、シンプルなSQLを使用して直感的に実行できます。'
            />
            <PerkCard
              icon={
                <svg
