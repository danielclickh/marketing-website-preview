    ...
    <div className='rounded-xl border border-neutral-700/80 bg-neutral-900/50 p-6'>
      <div className='flex w-full flex-col items-center pt-6'>
        ...
        <SuiTitle type='h2' className='mt-8 text-center'>
          リアルタイム分析に適したClickHouseの特徴
        </SuiTitle>
        <p className='mx-auto mb-10 max-w-4xl px-9 pt-6 text-center'>
          ユーザー向けのダッシュボードも、即時レスポンスのアプリケーションも、データをリアルタイムで分析する場合でも、ClickHouseなら簡単に構築できます。どれほど高度なデータ分析も、シンプルなSQLを使用して直感的に処理するよう実装できます。
        </p>
        <p className='mx-auto mb-12 max-w-3xl px-9 text-center'>
          並列クエリ実行エンジン、業界最高クラスの圧縮率、そしてカラム指向設計により、大規模なシステムでも圧倒的なパフォーマンスを実現します。これにより、インフラに煩わされずデータ分析に集中できます。
        </p>
      </div>
