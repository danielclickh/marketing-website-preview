...
*OLTP query retrieving a house prices by id  from the [UK based on price paid data](https://clickhouse.com/docs/en/getting-started/example-datasets/uk-price-paid)*
...
*OLAP query identifying the most expensive towns and districts in the [UK based on price paid data](https://clickhouse.com/docs/en/getting-started/example-datasets/uk-price-paid)*
