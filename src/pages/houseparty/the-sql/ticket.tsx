import imageHeroImage from './assets/hero-image.jpg'
import imageHeroTexture from './assets/hero-texture.png'
    ...
    return {
      props: {
        seo: {
          ...
          path: '/houseparty/the-sql/ticket',
...
export default function Page({ footerData, headerData, seo }: PageProps) {
  useGalaxyOnPage('reinvent2025AncillaryTicketPage')
  ...
  useEffect(() => {
    ;(async function () {
      if (router.isReady) {
        ...
        const authedStorage = localStorage.getItem('houseparty-vegas-2025')
        if (authedUrl || authedStorage) {
          // Save auth for accessing without query string
          if (!authedStorage) localStorage.setItem('houseparty-vegas-2025', '1')
          ...
          await router.push('/houseparty/vegas-2025')
        }
      }
    })()
  }, [router])
              ...
              <div className='m-auto px-6 text-center'>
                <div className='text-white'>
                  ...
                  <div className='mx-auto flex max-w-80 flex-wrap justify-center gap-4 text-neutral-0'>
                    <SocialButton
                      type='twitter'
                      url='https://clickhou.se/houseparty2025'
