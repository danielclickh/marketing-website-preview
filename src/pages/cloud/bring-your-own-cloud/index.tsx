  ...
  return {
    props: {
      seo: {
        ...
        description:
          'Request access for Bring Your Own Cloud. A fully managed ClickHouse service, deployed in your own AWS and GCP account.',
            ...
            <div className='flex flex-wrap items-center justify-center gap-12 lg:flex-nowrap lg:gap-16'>
              ...
              <div className='flip-selection w-full text-neutral-900 lg:w-1/2'>
                ...
                <p className='text-center text-[20px] leading-[180%] lg:text-left 2xl:max-w-xl'>
                  A fully managed ClickHouse service deployed in your own AWS or
                  GCP account.
                </p>
                ...
                <p className='mt-5 italic'>
                  <small>
                    * GCP BYOC is in private preview. Join the waitlist today!
                  </small>
                </p>
              </div>
