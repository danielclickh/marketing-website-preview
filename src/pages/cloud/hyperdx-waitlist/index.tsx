...
export const getStaticProps: GetStaticProps<CommonProps> =
  async function getStaticProps() {
    ...
    return {
      props: {
        seo: {
          title: 'HyperDX Waitlist',
          description:
            'HyperDX integration is coming to ClickHouse Cloud, sign up now to get on the waitlist.',
        ...
        <div className='mx-auto w-full lg:max-w-xl'>
          <div className='mb-16 text-center'>
            <SuiTitle type='h1' className='text-[28px] md:text-4xl'>
              HyperDX integration is coming to ClickHouse Cloud
            </SuiTitle>
          </div>
                  ...
                  <div className='mb-8 mt-4 space-y-4 text-center lg:mb-12 lg:mt-4'>
                    ...
                    <SuiText>
                      <span className='opacity-70'>
                        HyperDX integration is coming to ClickHouse Cloud! To
                        join the waitlist, simply answer the questions below.
                      </span>
                    </SuiText>
                  </div>
                  <MarketoForm
