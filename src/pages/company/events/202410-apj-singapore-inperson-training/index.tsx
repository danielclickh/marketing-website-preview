...
export const getStaticProps: GetStaticProps<EventProps> =
  async function getStaticProps() {
    const { data } = await findAll('events', {
      filters: {
        slug: {
          $eq: '202410-apj-singapore-inperson-training'
        }
      },
      ...
      'events',
      {
        filters: {
          $and: [
            ...
            {
              slug: {
                $notContains: '202410-apj-singapore-inperson-training'
              }
            },
            {
    ...
    return {
      props: {
        ...
        seo: {
          ...
          type: 'website',
          siteName: 'ClickHouse',
          path: '/company/events/202410-apj-singapore-inperson-training',
                ...
                {formSuccess && (
                  <div ref={formSuccessRef} className='text-center'>
                    ...
                    <p className='mt-2 text-neutral-200'>
                      We'll let you know via email once we've confirmed your
                      registration. Please also check your spam folder!
                    </p>
                  </div>
                )}
              </div>
