    ...
    <Layout footerData={footerData} seo={seo} headerData={headerData}>
      ...
      <section className='my-16 overflow-hidden lg:my-24'>
        <div className='section-container mx-auto flex flex-col gap-16 lg:flex-row lg:items-center lg:gap-10'>
          {/* Content */}
          <div className='mx-auto max-w-xl space-y-6 text-center lg:ml-0 lg:pr-12 lg:text-left'>
            <Image
              width={72}
              height={72}
            ...
            <SuiText className='text-neutral-200'>
              Deploy the full power of ClickHouse Cloud as a self-managed
              solution within any government network, including FedRAMP
              Moderate, High, and IL levels 2-6. Benefit from included NIST
              800-53 compliance documentation for simplified ATO. Initially
              available for AWS government users, this offering delivers all
      ...
      <section className='section-container my-16 flex flex-col gap-16 lg:my-24 lg:flex-row-reverse lg:items-center lg:justify-between lg:gap-10'>
        {/* Content */}
        <div className='mx-auto max-w-xl space-y-6 text-center lg:mr-0 lg:text-left'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            width='72'
            height='73'
