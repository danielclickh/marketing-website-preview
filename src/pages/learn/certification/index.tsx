            ...
            <Accordion
              ...
              items={[
                  ...
                  content: (
                    <>
                      <p className='mb-4'>
                        ...
                        ClickHouse expertise and tells both current and
                        prospective employers that you have the necessary skill
                        set that companies want and need for building and
                        deploying successful ClickHouse applications.
                      </p>
                      <p>
                        Our goal with the ClickHouse certification program is to
                        provide a meaningful and recognizable credential in the
                        software industry that companies can trust and be
                        confident in knowing you have a competitive advantage
                        and will be a more effective contributor on ClickHouse
                        projects.
                      </p>
                    </>
                  )
...

                {
                  ...
                  content: (
                    <p>
                      ...
                      efficient queries, and optimizing the performance of
                      queries.
                    </p>
                  )
                },

                {
                  ...
                  content: (
                    <p>
                      No - anyone can purchase and take an exam attempt.
                      However, it is highly recommended that you take our free
                      ClickHouse Developer training course, which covers all of
...

                {
                  ...
                  content: (
                    <p>
                      The exam is a hands-on, performance-based test where you
                      are given tasks to complete. You take the exam using your
                      own computer. We use a third-party vendor named HackerRank
                      which builds the exam environment, displays the exam
                      tasks, and provides a user interface for you to complete
                      the tasks.
                    </p>
                  )
                },
                ...
                {
                  onOpen: useGalaxyOnClick(
                    'certificationPage.faqSection.examCost'
                  ),
                  handle: 'How much does it cost to take the exam?',
                  content: (
                    <p>
                      The ClickHouse Certified Developer exam is $200 USD per
                      attempt. An exam attempt is valid for 365 days after
                      purchase, at which time it will expire. Note that exam
                      attempt purchases are not refundable.
                    </p>
                  )
                },
...

                {
                  ...
                  content: (
                    <p>
                      You will be given 2 hours to successfully complete 10 to
                      12 hands-on tasks.
                    </p>
                  )
                },

                {
                  ...
                  content: (
                    <p>
                      You will receive an email within 5 business days of your
                      exam completion.
                    </p>
                  )
                },
                ...
                {
                  onOpen: useGalaxyOnClick(
                    'certificationPage.faqSection.examSwag'
                  ),
                  handle: 'Do I get some swag if I get certified?',
                  content: (
                    <p>
                      Yes - of course! You will get a t-shirt with the
                      certification logo on it, as well as some stickers and
                      maybe a surprise or two in the swag box. In addition, we
                      hope to have special gatherings at ClickHouse conferences
                      to celebrate those of you who are certified, as well as
                      assist certified professionals who want to present at
...

                {
                  ...
                  content: (
                    <p>
                      ...
                      digital badge on LinkedIn, X, Facebook and all the other
                      usual social media platforms. You can also download and
                      print out a signed certificate of your credential.
                    </p>
                  )
                },

                {
                  ...
                  content: (
                    <p>
                      ...
                      access the exam on hackerrank.com. You will need to create
                      an account on HackerRank using the same email address used
                      to purchase the exam.
                    </p>
                  )
                },

                {
                  ...
                  content: (
                    <p>
                      You don't! You can take the exam right away after you
                      purchase an attempt, or any time up to 365 days after the
                      purchase date. You just take the exam whenever you are
                      ready. Be aware that the entire exam attempt will take
                      slightly more than 2 hours, because it can take up to 5-10
                      minutes for the exam environment to get built and to work
                      through the pre-exam process.
                    </p>
                  )
                },

                {
                  ...
                  content: (
                    <p>
                      Yes, using AI technology. No other person watches you take
                      the exam, but your exam attempt is monitored using your
                      web camera and an AI technology that verifies the same
                      person is taking the exam throughout the duration.
                      Therefore, your computer must have a functioning web
                      camera and the room should have good lighting. The exam
                      environment monitors any answers that seem to have been
                      generated by an AI tool. The exam environment also records
                      your screen for each task, and monitors when you leave the
                      exam tab in your web browser, which you are allowed to do
                      only for accessing the documentation or for translating
...

                {
                  ...
                  handle:
                    'Can I have access to the documentation during the exam?',
                  content: (
                    <p>
                      Yes, you can go to the ClickHouse docs in a separate tab
                      in your browser.
                    </p>
                  )
                },

                {
                  ...
                  content: (
                    <p>
                      No. The AI proctoring notifies us if an external monitor
                      is attached.
                    </p>
                  )
                },

                {
                  ...
                  content: (
                    <p>
                      No. The only external resource you are allowed to access
                      is on clickhouse.com, which includes the documentation,
                      blogs and any other articles posted there.
                    </p>
                  )
                },

                {
                  ...
                  content: (
                    <p>
                      The passing score is 70%. Not all tasks are weighted
                      equally, as some tasks are more difficult or take longer
                      to complete. Most of the exam is graded by scripts, but
                      note that we manually review the results of every exam
                      attempt, so you will not get your exam results
                      immediately. It can take up to 5 business days to get your
                      exam results.
                    </p>
                  )
                },
...

                {
                  ...
                  content: (
                    <p>
                      There is no limit to the number of exam attempts you can
                      take. You do have to purchase each exam attempt at $200
                      USD, and you must wait 7 days from your previous attempt
...

                {
                  ...
                  content: (
                    <p>
                      Sure - you can get up and stretch your legs and leave the
                      room if necessary. Keep in mind that taking a break does
                      not stop the timer on the exam. Once you start the exam,
                      it will end in two hours (or sooner if you complete all
                      the tasks and submit the exam manually).
                    </p>
                  )
                },
