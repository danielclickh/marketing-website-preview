import chartCostsLoading from './assets/chart-costs-loading.svg'
import chartCostsQueryingSpeed from './assets/chart-costs-querying-speed.svg'
import chartCostsQuering from './assets/chart-costs-querying.svg'
import chartCostsStoring from './assets/chart-costs-storing.svg'
import iconBullseye from './assets/icon-bullseye.svg'
import iconCoins from './assets/icon-coins.svg'
import iconSpeedometer from './assets/icon-speedometer.svg'
...
export interface BigQueryCostsPageProps extends ComparisonProps {
...
export async function getStaticProps() {
  ...
  if (seo) {
    seo.title =
      'ClickHouse vs BigQuery - Migrate to ClickHouse for improved cost-efficiency and blazing-fast performance.'
    seo.description =
      'Improve your cost efficiency with ClickHouse. And achieve better performance, too.'
    seo.path = `/comparison/${comparison.slug}/costs`
  }

  const props: BigQueryCostsPageProps = {
    comparison,
    customerStories,
    seo,
                ...
                content={
                  <>
                    ...
                    <SuiText className='sm:text-xl'>
                      ...
                      effectively, but scaling turns cost and performance
                      management into a significant challenge.
                    </SuiText>
                    <SuiText className='sm:text-xl'>
                      Migrate to ClickHouse for improved cost-efficiency and
                ...
                content={
                  <>
                    ...
                    <SuiText className='sm:text-xl'>
                      BigQuery handles ad-hoc queries and smaller data volumes
                      effectively, but scaling turns cost and performance
                      management into a significant challenge. Migrate to
                      ClickHouse for improved cost-efficiency and blazing-fast
                      performance.
                    </SuiText>
                  </>
                }
          ...
          <CUICard className='gap-6 !bg-neutral-700 p-6 sm:gap-10 sm:p-10'>
            <CUICard.Body className='max-w-[800px] space-y-6 text-center'>
              ...
              <SuiText>
                ...
                insights and forget worrying about infrastructure.
              </SuiText>
            </CUICard.Body>
