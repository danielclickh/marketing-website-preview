!(function (e) {
  function webpackJsonpCallback(t) {
    for (var r, o, i = t[0], s = t[1], c = 0, u = []; c < i.length; c++)
      (o = i[c]), n[o] && u.push(n[o][0]), (n[o] = 0)
  ...
  ;(__webpack_require__.e = function requireEnsure(e) {
    ...
    if (0 !== r)
      if (r) t.push(r[2])
        ...
        ;(a.charset = 'utf-8'),
          ...
          (a.src = (function jsonpScriptSrc(e) {
            return (
              __webpack_require__.p +
              'assets/' +
              ({}[e] || e) +
              '.' +
              { 1: '37afe153', 2: '2a722653', 3: 'ee35dea2' }[e] +
              '.chunk.js'
            )
          })(e))
        var s = new Error()
    ...
    (__webpack_require__.p = '/conductor/'),
    (__webpack_require__.oe = function (e) {
      throw (console.error(e), e)
    })
  var r = (window['3eiXJRXgVuLsYGH9303q'] =
      window['3eiXJRXgVuLsYGH9303q'] || []),
    o = r.push.bind(r)
        ...
        function api(t, n, r) {
          ...
          if ('undefined' !== typeof document) {
            if (arguments.length > 1) {
              if (
                'number' ===
                typeof (r = extend({ path: '/' }, api.defaults, r)).expires
              ) {
                var i = new Date()
            ...
            for (
              ...
              try {
                ...
                if (
                  ((d = e.read
                    ? e.read(d, p)
                    : e(d, p) || d.replace(u, decodeURIComponent)),
                  this.json)
                )
                  try {
                    d = JSON.parse(d)
    ...
    ;(function (r) {
      ...
      !(function () {
        ...
        function p() {
          ...
          e || (e = i.Symbol.iterator = i.Symbol('iterator')),
        ...
        function z(e, n) {
          for (var r = (e = t(e)).next(); !r.done; r = e.next())
            if (
              ((r = r.value),
              n.includes(r.nodeName.toLowerCase()) || z(r.children, n))
            )
              return !0
          return !1
        }
        function B(e, n) {
          ...
          for (var r = [], o = (n = t(n)).next(); !o.done; o = n.next())
            (o = o.value),
              r.push({ timestamp: o.start, type: 'requestStart' }),
              r.push({ timestamp: o.end, type: 'requestEnd' })
          for (o = (n = t(e)).next(); !o.done; o = n.next())
            r.push({ timestamp: o.value, type: 'requestStart' })
          for (
            r.sort(function (e, t) {
          ...
          ;(this.a = e
            ...
            (function D(e) {
              ;(e.c = new PerformanceObserver(function (n) {
                for (
                  var r = (n = t(n.getEntries())).next();
                  !r.done;
                  r = n.next()
                )
                  if (
                    ('resource' === (r = r.value).entryType &&
                      (e.b.push({ start: r.fetchStart, end: r.responseEnd }),
                      G(e, B(e.g, e.b) + 5e3)),
                    'longtask' === r.entryType)
                  ) {
                    var o = r.startTime + r.duration
                    e.a.push({ start: r.startTime, end: o }), G(e, o + 5e3)
                  }
              })),
            ...
            this.w &&
              (this.h = (function A(e) {
                var n = new MutationObserver(function (n) {
                  for (var r = (n = t(n)).next(); !r.done; r = n.next())
                    'childList' == (r = r.value).type && z(r.addedNodes, f)
                      ? e(r)
                      : 'attributes' == r.type &&
                        f.includes(r.target.tagName.toLowerCase()) &&
                        e(r)
                })
                return (
                  n.observe(document, {
          ...
          !e.i ||
            ...
            (e.j = setTimeout(function () {
              ...
              5e3 > o - n
                ? (n = null)
                : (n =
                    5e3 > o - (n = i.length ? i[i.length - 1].end : t)
                      ? null
                      : Math.max(n, r)),
                n &&
                  (e.s(n),
        ...
        var d = {
          getFirstConsistentlyInteractive:
            function getFirstConsistentlyInteractive(e) {
              return (
                (e = e || {}),
                'PerformanceLongTaskTiming' in window
                  ? new C(e).getFirstConsistentlyInteractive()
  ...
  function (e, t, n) {
    var r = (function (e) {
          ...
          (i._invoke = (function makeInvokeMethod(e, t, n) {
            ...
            return function invoke(o, i) {
              ...
              for (n.method = o, n.arg = i; ; ) {
                ...
                'throw' === p.type &&
                  ((r = l), (n.method = 'throw'), (n.arg = p.arg))
              }
            }
          })(e, n, a)),
          i
      ...
      return (
        (GeneratorFunction.prototype = g.constructor =
        ...
        (e.exports = (function (e) {
          ...
          function (e, n, r) {
            ...
            function getOpener(e) {
              if ((void 0 === e && (e = window), e && !getParent(e)))
                try {
                  return e.opener
                } catch (t) {}
            }
            ...
            function isSameDomain(e) {
              if (
                !(function (e) {
                  ...
                  try {
                    if (getActualDomain(e) === getActualDomain(window))
                      return !0
                  } catch (n) {}
                  return !1
                })(e)
            ...
            function getAncestor(e) {
              return (
                void 0 === e && (e = window),
                getOpener((e = e || window)) || getParent(e) || void 0
              )
            }
            ...
            var l = (function () {
              ...
              return (
                ...
                (e.dispatch = function () {
                  ...
                  if (!this.dispatching && (e || t)) {
                    ...
                    for (
                      ...
                      if (
                        u instanceof ZalgoPromise &&
                        (u.resolved || u.rejected)
                      ) {
                        var f = u
                        f.resolved ? c.resolve(f.value) : c.reject(f.error),
                          (f.errorHandled = !0)
                      } else
                        utils_isPromise(u)
                          ? u instanceof ZalgoPromise &&
                ...
                (ZalgoPromise.resolve = function (e) {
                  return e instanceof ZalgoPromise
                    ? e
                    : utils_isPromise(e)
                    ? new ZalgoPromise(function (t, n) {
                        return e.then(t, n)
                      })
                ...
                (ZalgoPromise.isPromise = function (e) {
                  return (
                    !!(e && e instanceof ZalgoPromise) || utils_isPromise(e)
                  )
                }),
              ...
              p = (function () {
                ...
                return (
                  ...
                  (e.set = function (e, t) {
                    ...
                    var i = this.keys,
                      a = this.values,
                      s = util_safeIndexOf(i, e)
                    ;-1 === s ? (i.push(e), a.push(t)) : (a[s] = t)
                  }),
                  (e.get = function (e) {
                    if (!e) throw new Error('WeakMap expected key')
                    var t = this.weakmap
                  ...
                  (e.has = function (e) {
                    ...
                    return (
                      this._cleanupClosedWindows(),
                      -1 !== util_safeIndexOf(this.keys, e)
                    )
                  }),
            ...
            function memoize(e, t) {
              ...
              var c = function memoizedFunction() {
                for (
                  var t = arguments.length, o = new Array(t), c = 0;
                  c < t;
                  c++
                )
                  o[c] = arguments[c]
                var u, f
                s < m && ((n = null), (r = null), (s = h), (h += 1)),
                  (u = i
                    ? (r = r || new p()).getOrSet(this, getEmptyObject)
                    : (n = n || {}))
                try {
                  f = serializeArgs(o)
                } catch (v) {
              ...
              return (
                ...
                setFunctionName(
                  c,
                  (t.name || getFunctionName(e)) + '::memoized'
                )
              )
            }
            function memoizePromise(e) {
              ...
              return (
                ...
                setFunctionName(
                  ...
                  getFunctionName(e) + '::promiseMemoized'
                )
              )
            }
            ...
            function stringifyError(e, t) {
              ...
              try {
                ...
                return (
                  'Error while stringifying error: ' + stringifyError(o, t + 1)
                )
              }
            }
            ...
            function globalStore(e, t) {
              return (
                void 0 === e && (e = 'store'),
                void 0 === t && (t = y),
                util_getOrSet(global_getGlobal(), e, function () {
                  var e = t()
                  return {
                    has: function has(t) {
            ...
            function getWildcard() {
              ...
              return (
                (e.WINDOW_WILDCARD = e.WINDOW_WILDCARD || new b()),
                e.WINDOW_WILDCARD
              )
            }
            function windowStore(e, t) {
              return (
                void 0 === e && (e = 'store'),
                void 0 === t && (t = y),
                globalStore('windowStore').getOrSet(e, function () {
                  var n = new p(),
            ...
            function sayHello(e, t) {
              return (0, t.send)(
                ...
                var n = t.origin,
                  r = t.data.instanceID
                return (
                  resolveHelloPromise(e, { domain: n }),
            ...
            function getWindowInstanceID(e, t) {
              var n = t.send
              return windowStore('windowInstanceIDPromises').getOrSet(
                e,
                function () {
                  return sayHello(e, { send: n }).then(function (e) {
                    return e.instanceID
                  })
                }
              )
            ...
            function cleanupProxyWindows() {
              for (
                var e = globalStore('idToProxyWindow'), t = 0, n = e.keys();
                t < n.length;
                t++
              ) {
                var r = n[t]
            ...
            function getSerializedWindow(e, t) {
              ...
              var s = function getName() {
                return e.then(function (e) {
                  if (!isWindowClosed(e))
                    return isSameDomain(e) ? assertSameDomain(e).name : i
                })
              }
              return {
                id: o,
                ...
                getInstanceID: memoizePromise(function () {
                  return e.then(function (e) {
                    return getWindowInstanceID(e, { send: n })
                  })
                }),
                            ...
                            if (
                              ...
                              for (
                                ...
                                l.setAttribute('name', f),
                                  l.setAttribute(
                                    'value',
                                    null == (u = r[f]) ? void 0 : u.toString()
                                  ),
                                  a.appendChild(l)
                              }
                            getBody().appendChild(a),
                              a.submit(),
                              getBody().removeChild(a)
              ...
              function ProxyWindow(e) {
                ...
                ;(this.id = void 0),
                  ...
                  (this.serializedWindow =
                    r ||
                    getSerializedWindow(this.actualWindowPromise, { send: t })),
              ...
              return (
                ...
                (e.focus = function () {
                  var e = this,
                    t = this.isPopup(),
                    n = this.getName(),
                    r = l.hash({ isPopup: t, name: n }).then(function (e) {
                      var t = e.name
                ...
                (e.setWindow = function (e, t) {
                  ...
                  ;(this.actualWindow = e),
                    ...
                    (this.serializedWindow = getSerializedWindow(
                ...
                (e.shouldClean = function () {
                  return Boolean(
                    this.actualWindow && isWindowClosed(this.actualWindow)
                  )
                }),
                ...
                (ProxyWindow.serialize = function (e, t) {
                  ...
                  return (
                    cleanupProxyWindows(),
                    ProxyWindow.toProxyWindow(e, { send: n }).serialize()
                  )
                }),
                (ProxyWindow.deserialize = function (e, t) {
                  ...
                  return (
                    cleanupProxyWindows(),
                    globalStore('idToProxyWindow').get(e.id) ||
                      new ProxyWindow({ serializedWindow: e, send: n })
                  )
                }),
                ...
                (ProxyWindow.toProxyWindow = function (e, t) {
                  var n = t.send
                  if ((cleanupProxyWindows(), ProxyWindow.isProxyWindow(e)))
                    return e
                  var r = e
                  return (
                    windowStore('winToProxyWindow').get(r) ||
                    new ProxyWindow({ win: r, send: n })
                  )
                }),
                ProxyWindow
              )
            ...
            function function_serializeFunction(e, t, n, r, o) {
              ...
              ;(a = (i = { on: o.on, send: o.send }).on),
                (s = i.send),
                globalStore('builtinListeners').getOrSet(
                  'functionCalls',
                  function () {
                    return a('postrobot_method', { domain: '*' }, function (e) {
                      ...
                      return l
                        ...
                        .then(
                          function () {
                            return f.apply({ source: t, origin: n }, r.args)
                          },
                          function (e) {
                            return l
                              .try(function () {
              ...
              return (
                ...
                I.isProxyWindow(e)
                  ...
                  : addMethod(c, n, u, e, t),
                serializeType('cross_domain_function', { id: c, name: u })
              )
            }
            function serializeMessage(e, t, n, r) {
              ...
              return (function (e, t) {
                ...
                (((o = {}).promise = function (n, r) {
                  return (function (e, t, n, r, o) {
                    return serializeType('cross_domain_zalgo_promise', {
                      then: function_serializeFunction(
                        e,
                        t,
                        function (e, t) {
                          return n.then(e, t)
                ...
                (o.object = function (e) {
                  return isWindow(e) || I.isProxyWindow(e)
                    ? serializeType(
                        'cross_domain_window',
                        I.serialize(e, { send: a })
                      )
                    : e
                }),
                o)
                    ...
                    var o = n.id,
                      ...
                      s = function getDeserializedFunction(n) {
                        function crossDomainFunctionWrapper() {
                          var r = arguments
                          return I.toProxyWindow(e, { send: a })
                            .awaitWindow()
                            .then(function (e) {
                              var s = lookupMethod(e, o)
                              if (s && s.val !== crossDomainFunctionWrapper)
                                return s.val.apply(
                        ...
                        return (
                          void 0 === n && (n = {}),
                          (crossDomainFunctionWrapper.__name__ = i),
                          (crossDomainFunctionWrapper.__origin__ = t),
                          (crossDomainFunctionWrapper.__source__ = e),
                          (crossDomainFunctionWrapper.__id__ = o),
                          (crossDomainFunctionWrapper.origin = t),
                          crossDomainFunctionWrapper
                        )
                      },
                      c = s()
                    return (c.fireAndForget = s({ fireAndForget: !0 })), c
                  })(e, t, n, { send: i })
                }),
                (o.cross_domain_window = function (e) {
                  return I.deserialize(e, { send: i })
                }),
                o)
              )
            }
                      ...
                      l.flush().then(function () {
                        ...
                        var n,
                          a = serializeMessage(
                            e,
                            t,
                            (((n = {}).__post_robot_10_0_46__ = r.buffer || []),
                            n),
                            { on: o, send: i }
                          )
                        delete r.buffer
                        for (
                          var s = Object.keys(k), c = [], u = 0;
                          u < s.length;
                          u++
                        ) {
                          var f = s[u]
            ...
            function handleRequest(e, t, n, r) {
              var o = r.on,
                i = r.send,
                a = getRequestListener({ name: n.name, win: e, domain: t }),
                s =
              ...
              function sendResponse(r, a, c) {
                return l.flush().then(function () {
                  if (!n.fireAndForget && !isWindowClosed(e))
                    try {
                      return send_sendMessage(
                        e,
                        t,
                        {
                          id: uniqueID(),
            ...
            function receive_receiveMessage(e, t) {
              ...
              var i = e.source,
                ...
                s = (function (e, t, n, r) {
                  var o,
                    ...
                    a = r.send
                  try {
                    o = deserializeMessage(t, n, e, { on: i, send: a })
                  } catch (f) {
                    return
                  }
              ...
              if (s) {
                ...
                for (var c = 0; c < s.length; c++) {
                  ...
                  if ((o.set(u.id, !0), isWindowClosed(i) && !u.fireAndForget))
                    return
                  0 === u.origin.indexOf('file:') && (a = 'file://')
                  try {
                    'postrobot_message_request' === u.type
                      ? handleRequest(i, a, u, { on: n, send: r })
                      : 'postrobot_message_response' === u.type
                      ? handleResponse(i, a, u)
                      : 'postrobot_message_ack' === u.type && handleAck(i, a, u)
                  } catch (f) {
                    setTimeout(function () {
                      throw f
                    }, 0)
            ...
            function on_on(e, t, n) {
              ...
              var r = (function addRequestListener(e, t) {
                ...
                if (r && '*' !== r && I.isProxyWindow(r)) {
                  var a = r.awaitWindow().then(function (e) {
                    return addRequestListener({ name: n, win: e, domain: o }, t)
                  })
                  return {
                    cancel: function cancel() {
                      a.then(function (e) {
                ...
                var s = r
                if (Array.isArray(s)) {
                  for (var c = [], u = 0, f = s; u < f.length; u++)
                    c.push(
                      addRequestListener({ name: n, domain: o, win: f[u] }, t)
                    )
                  return {
                    cancel: function cancel() {
                ...
                if (Array.isArray(o)) {
                  for (var l = [], d = 0, p = o; d < p.length; d++)
                    l.push(
                      addRequestListener({ name: n, win: s, domain: p[d] }, t)
                    )
                  return {
                    cancel: function cancel() {
                ...
                var h = getRequestListener({ name: n, win: s, domain: o })
                ;(s && '*' !== s) || (s = getWildcard())
                var m = (o = o || '*').toString()
                if (h)
                  throw s && o
                    ? new Error(
                        'Request listener already exists for ' +
                          ...
                          o.toString() +
                          ' for ' +
                          (s === getWildcard() ? 'wildcard' : 'specified') +
                          ' window'
                      )
                    : s
                    ? new Error(
                    ...
                    : new Error('Request listener already exists for ' + n)
                var g,
                  v,
                  w = i.getOrSet(s, function () {
                    return {}
                  }),
                  y = util_getOrSet(w, n, function () {
                    return {}
                  })
                return (
                  util_isRegex(o)
                    ? (g = util_getOrSet(y, '__domain_regex__', function () {
                        return []
                      })).push((v = { regex: o, listener: t }))
                    : (y[m] = t),
                  {
                    cancel: function cancel() {
                      delete y[m],
                        v &&
                          (g.splice(g.indexOf(v, 1)),
                          g.length || delete y.__domain_regex__),
                        Object.keys(y).length || delete w[n],
                        s && !Object.keys(w).length && i.del(s)
                    }
                  }
                )
              })(
            ...
            k.postrobot_post_message = function (e, t, n) {
            ...
            var T = function send(e, t, n, r) {
              var o = (r = r || {}).domain || '*',
                ...
                a = r.timeout || 5e3,
                s = r.fireAndForget || !1
              return I.toProxyWindow(e, { send: send })
                .awaitWindow()
                .then(function (e) {
                  return l
                    .try(function () {
                      if (
                        ...
                        (function (e, t) {
                          ...
                          if (
                            (function (e) {
                              ...
                              try {
                                if (isAncestorParent(window, e) && window.top)
                                  return window.top
                              } catch (o) {}
                              try {
                                if (isAncestorParent(e, window) && window.top)
                                  return window.top
                              } catch (o) {}
                              for (
                                var t = 0,
                                  n = (function getAllChildFrames(e) {
                                    for (
                                      var t = [], n = 0, r = getFrames(e);
                                      n < r.length;
                                      n++
                                    ) {
                                      var o = r[n]
                        ...
                        return (function (e, t, n) {
                          void 0 === t && (t = 5e3),
                            void 0 === n && (n = 'Window')
                          var r = (function (e) {
                            return windowStore('helloPromises').getOrSet(
                              e,
                              function () {
                                return new l()
                              }
                    ...
                    .then(function (t) {
                          ...
                          return 'string' == typeof t
                            ...
                            : l
                                .try(function () {
                                  return (
                                    n ||
                                    sayHello(e, { send: o }).then(function (e) {
                                      return e.domain
                                    })
                                  )
                                })
                      ...
                      })(e, o, (void 0 === t ? {} : t).domain, { send: send })
                    })
                    .then(function (r) {
                      var o = r,
                        a =
                        ...
                        u = t + '_' + uniqueID()
                      if (!s) {
                        var f = { name: t, win: e, domain: o, promise: c }
                        !(function (e, t) {
                          globalStore('responseListeners').set(e, t)
                        })(u, f)
                        var d = windowStore('requestPromises').getOrSet(
                          e,
                          function () {
                            return []
                          }
                        ...
                        c.finally(function () {
                          v.cancel(), d.splice(d.indexOf(c, 1))
                        }).catch(src_util_noop)
                      }
                      return send_sendMessage(
                        e,
            ...
            function setup_serializeMessage(e, t, n) {
              return serializeMessage(e, t, n, { on: on_on, send: T })
            }
            function setup_deserializeMessage(e, t, n) {
              return deserializeMessage(e, t, n, { on: on_on, send: T })
            }
            function createProxyWindow(e) {
              return new I({ send: T, win: e })
            }
            function setup_toProxyWindow(e) {
              return I.toProxyWindow(e, { send: T })
            }
            function setup() {
              var e, t, n, r
              global_getGlobal().initialized ||
                ((global_getGlobal().initialized = !0),
                (t = (e = { on: on_on, send: T }).on),
                (n = e.send),
                ((r = global_getGlobal()).receiveMessage =
                  r.receiveMessage ||
                  function (e) {
                    return receive_receiveMessage(e, { on: t, send: n })
                  }),
                (function (e) {
                  var t = e.on,
                    n = e.send
                  ...
                  globalStore('builtinListeners').getOrSet(
                    ...
                    function () {
                      var e = t(
                        ...
                        r = getAncestor()
                      return (
                        r && sayHello(r, { send: n }).catch(function (e) {}), e
                      )
                    }
                  )
                })({ on: on_on, send: T }))
            ...
            function destroy() {
              ...
              !(function () {
                for (
                  var e = globalStore('responseListeners'), t = 0, n = e.keys();
                  t < n.length;
                  t++
                ) {
                  var r = n[t],
                ...
                (e = globalStore().get('postMessageListener')) && e.cancel(),
                delete window.__post_robot_10_0_46__
            }
            var C = !0
            function cleanUpWindow(e) {
              for (
                var t = 0, n = windowStore('requestPromises').get(e, []);
                t < n.length;
                t++
              )
                n[t]
                  .reject(
                    new Error(
                      'Window ' +
                        (isWindowClosed(e) ? 'closed' : 'cleaned up') +
                        ' before response'
                    )
                  )
                  .catch(src_util_noop)
        ...
        (Buffer.prototype.fill = function fill(e, t, n, r) {
          ...
          if (
            ...
            var a = Buffer.isBuffer(e)
                ? e
                : utf8ToBytes(new Buffer(e, r).toString()),
              s = a.length
          ...
          t = Math.abs(t),
            isNaN(t) || t === 1 / 0
              ...
              : ((a = Math.floor(Math.log(t) / Math.LN2)),
                ...
                (t += a + l >= 1 ? d / c : d * Math.pow(2, 1 - l)) * c >= 2 &&
                  (a++, (c /= 2)),
                a + l >= f
                  ? ((s = 0), (a = f))
                  : a + l >= 1
                  ? ((s = (t * c - 1) * Math.pow(2, o)), (a += l))
    ...
    function addStyle(e, t) {
      ...
      if (t.singleton) {
        ...
        ;(n = a || (a = createStyleElement(t))),
          (r = applyToSingletonTag.bind(null, n, c, !1)),
  ...
  function (e, t, n) {
    ...
    n.r(r),
      n.d(r, 'collectFormData', function () {
        return Nn
      }),
    ...
    var a = n(4),
      ...
      f = u('PRODUCTION')
        ...
        : u('MASTER')
        ? a
        : _objectSpread2(_objectSpread2({}, a), s)
    ...
    function _curry1(e) {
      return function f1(t) {
        return 0 === arguments.length || _isPlaceholder(t)
          ? f1
      ...
      return function f2(t, n) {
        switch (arguments.length) {
          case 0:
            return f2
          case 1:
            return _isPlaceholder(t)
              ? f2
              : _curry1(function (n) {
                  return e(t, n)
                })
          default:
            return _isPlaceholder(t) && _isPlaceholder(n)
              ? f2
              : _isPlaceholder(t)
              ? _curry1(function (t) {
                  return e(t, n)
    ...
    function _curry3(e) {
      return function f3(t, n, r) {
        switch (arguments.length) {
          ...
          default:
            return _isPlaceholder(t) && _isPlaceholder(n) && _isPlaceholder(r)
              ? f3
              : _isPlaceholder(t) && _isPlaceholder(n)
              ? _curry2(function (t, n) {
                  return e(t, n, r)
                })
              : _isPlaceholder(t) && _isPlaceholder(r)
              ? _curry2(function (t, r) {
                  return e(t, n, r)
                })
              : _isPlaceholder(n) && _isPlaceholder(r)
              ? _curry2(function (n, r) {
                  return e(t, n, r)
                })
              : _isPlaceholder(t)
    ...
    var w = Object.prototype.toString,
      y = (function () {
        return '[object Arguments]' === w.call(arguments)
          ? function _isArguments(e) {
              return '[object Arguments]' === w.call(e)
            }
          : function _isArguments(e) {
          ...
          ? _curry1(function keys(e) {
              ...
              if (x)
                for (n = A.length - 1; n >= 0; )
                  _has((t = A[n]), e) && !O(r, t) && (r[r.length] = t), (n -= 1)
              return r
            })
          : _curry1(function keys(e) {
    ...
    function _equals(e, t, n, r) {
      ...
      var a = I(e)
      if (a.length !== I(t).length) return !1
      var s = n.concat([e]),
        c = r.concat([t])
    ...
    var P = function init() {
      ...
      D = (function () {
        ...
        return (
          (XDrop.prototype['@@transducer/init'] = P),
          (XDrop.prototype['@@transducer/result'] = R),
          (XDrop.prototype['@@transducer/step'] = function (e, t) {
            return this.n > 0
              ? ((this.n -= 1), e)
    ...
    function _checkForMethod(e, t) {
      return function () {
        ...
        if (0 === n) return t()
        var r = arguments[n - 1]
        return _(r) || 'function' !== typeof r[e]
          ? t.apply(this, arguments)
          : r[e].apply(r, Array.prototype.slice.call(arguments, 0, n - 1))
      }
    }
    var F = _curry3(
        _checkForMethod('slice', function slice(e, t, n) {
          return Array.prototype.slice.call(n, e, t)
        })
      ),
      B = _curry2(
        _dispatchable(['drop'], L, function drop(e, t) {
    ...
    var Y = (function getOrCreateFramesMap() {
        var e = {}
        return window._driftFrames
          ? window._driftFrames
          : ((window._driftFrames = e), e)
      })(),
      V = n(5)
    function _reduced(e) {
    ...
    var X = (function () {
        ...
        return (
          (XAny.prototype['@@transducer/init'] = P),
          (XAny.prototype['@@transducer/result'] = function (e) {
            return (
          ...
          (XAny.prototype['@@transducer/step'] = function (e, t) {
            return (
              this.f(t) &&
                ((this.any = !0),
                (e = _reduced(this.xf['@@transducer/step'](e, !0)))),
              e
            )
          }),
          XAny
      ...
      J = !!(
        g('', ['location', 'search'], window).indexOf('driftDebugFrame') > -1
      ),
      K = [],
      Q = function listen(e) {
        var t = e.topic,
            ...
            o = Object(V.on)(
              ...
              (function handlerFunctionWrapper(e, t) {
                return function handlerWrapper(n) {
                  ...
                  if (n.source === window || r)
                    return (
                      J &&
                        console.debug(
                          ''
                            .concat(f.PROJECT_NAMESPACE, ':LISTEN: ')
                            .concat(e, '::'),
                          n
                        ),
                      t.apply(this, arguments)
                    )
                  ae({ data: ['message from untrusted frame', n] })
                }
              })(t, n)
            )
          K.push(o)
                  ...
                  switch ((i.prev = i.next)) {
                        ...
                        ce(
                          new Error(
                            'Failed to find frame '
                              .concat(t, ' to broadcast message to topic ')
                              .concat(r)
                          )
                        ),
                        i.abrupt('return')
                    ...
                    case 4:
                      ...
                      return (
                        ce(
                          new Error(
                            'Failed to grab frame element for frame '
                              .concat(t, ' to broadcast message to topic ')
                              .concat(r)
                          )
                        ),
                    ...
                    case 8:
                      return (
                        (c = _objectSpread2(
                          { _meta: { id: ie(), source: 'drift_widget' } },
                          n
                        )),
                        (i.prev = 9),
                        ae({
                          data: [
                            'SEND: '.concat(t, ' | ').concat(c._meta.id),
                            c
                          ]
                        }),
                        (i.next = 13),
                        Object(V.send)(s.contentWindow, r, c, {
                          timeout: 2e4,
                    ...
                    case 13:
                      return (
                        ...
                        ae({
                          data: [
                            'RESPONSE: '.concat(t, ' | ').concat(c._meta.id),
                            u
                          ]
                        }),
                        i.abrupt('return', u)
                    ...
                    case 18:
                      ;(i.prev = 18),
                        ...
                        ae({ type: 'warn', data: ['Original message', n] })
                    case 22:
                    case 'end':
                      return i.stop()
                  }
      ...
      te = !!(
        g('', ['location', 'search'], window).indexOf('driftEnableLog') > -1
      ),
      ...
      ae = function log(e) {
        ...
        ;(o = Array.isArray(o) ? o : [o]),
          ne &&
            (t = console)[r].apply(
              t,
              [''.concat(f.PROJECT_NAMESPACE, '::')].concat(
      ...
      ce = function error(e, t) {
        ...
        !(function errorHandler(e) {
          if (re) throw e
          ae({ type: 'warn', data: [e.message] }),
            (function sendErrorToController(e) {
              Y[M.CONTROLLER] &&
                window.drift.controllerReady &&
                ee({
                  name: 'controller',
      ...
      le = function debounce(e, t, n) {
        ...
        return function () {
          ...
          r
            ? (clearTimeout(r), (r = window.setTimeout(c, t)))
            : (r = window.setTimeout(c, 10)),
            s && e.apply(void 0, i)
        }
      },
      ...
      he = function getWidgetDomain() {
        if (
          pe('PRODUCTION') &&
          (function isDevEmbed() {
            return N('-dev', g('', ['drift', 'embedId'], window))
          })()
        )
          return 'https://'.concat(f.WIDGET_ROOT_QA)
        if (!pe('PRODUCTION') && !pe('MASTER'))
          return 'http://'.concat(f.WIDGET_ROOT)
    ...
    var ve = n(1),
      ...
      ye = 76,
      _e = 400,
      be = { EMAILCAPTURE: '400px', SLIDER: '450px' },
      Ee = '100%',
      xe = '0px',
      Ae = Ee,
      Se = Ee,
      Oe = 'auto',
      Ie = function getWidgetAlignment(e) {
        return e.$div.classList.contains(
          ''.concat('drift-frame', '-').concat(e.name, '-align-right')
        )
          ? U
          : z
      }
    ...
    var ke = void 0,
      Te = function isMobileDevice() {
        ...
        return void 0 === ke && (ke = Ce(e) || Re(e)), ke
      },
      Ce = function isAndroid() {
        ...
        return (
          /Android/i.test(
            null === (e = navigator) || void 0 === e ? void 0 : e.userAgent
          ) &&
          (o ||
      ...
      We = 512,
      Ne = 640,
      Me = function getTargetedBreakpointByBrowser() {
        return (
          Fe ||
            (Fe = (function isFirefox() {
        ...
        return (
          (function getCurrentWidth() {
            ...
            return window.drift_iframe_mode
              ? null === (t = window.drift_iframe_window_context) ||
                void 0 === t
                ? void 0
                : null === (n = t.window) || void 0 === n
                ? void 0
                : n.innerWidth
              : window.innerWidth > 0
              ? window.innerWidth
      ...
      ze = function getFrameStyles(e) {
        ...
        if (
          (r ? (a['max-height'] = n) : (a.height = n),
          'controller' === e && (a.bottom = i ? xe : '24px'),
          'slider' === e)
        ) {
          var s = je() ? '-20' : '20'
          ;(a.bottom = i ? '0' : '18px'),
            (a.height = 'calc(100% + '.concat(s, 'px)')),
            i && (a.maxWidth = '335px')
        }
        return (
          'emailCapture' === e &&
            ((a.bottom = xe), (a.height = 'calc(100% + 30px)')),
          ('takeover' !== e && 'chat__takeover' !== e) ||
            ((a.left = xe),
            (a.top = xe),
            (a.bottom = Oe),
            (a.right = Oe),
          ...
          'chat' === e &&
            ...
            (a.height = Ee),
            (a.width = Ee),
            o === U ? (a.right = '12px') : o === z && (a.left = '12px')),
          a
        )
      },
      ...
      qe = function setDivAlignment(e, t, n) {
        var r = Te(),
          ...
          i = r ? '0' : '24px'
        'slider' === t &&
          ((o = r ? '68px' : '92px'), (i = r ? '68px' : '92px')),
          'emailCapture' === t && ((o = '0'), (i = '0')),
          'left' === n
            ? (e.style.left = o)
            : 'right' === n && (e.style.right = i)
      }
    const He = {
        ...{ API_READY: 'drift::apiReady', READY: 'drift::ready' },
        ...{
        ...
        ...{
          ...
          CONVERSATION_PLAYBOOK_DISMISSED:
            'drift::conversation:playbookDismissed'
        },
        ...{
        ...
        ...{ CHAT_OPENED: 'drift::chatOpen', CHAT_CLOSED: 'drift::chatClose' },
        ...{
      ...
      $e = [
        ...
        'showAwayMessage',
        'showWelcomeMessage',
        'showWelcomeOrAwayMessage',
        'stageFormData',
        'startInteraction',
        'startVideoGreeting',
        'toggleChat',
        'toggleChatTakeoverModal'
      ],
      Ye = ['hide', 'show'],
    ...
    !(function () {
      ...
      var e = { bubbles: !1, cancelable: !1, detail: void 0 }
    ...
    var et,
      tt = function createEvent(e, t) {
        if (!window.drift.ready && !Qe(e, Ke) && e !== He.BOOTSTRAP_FAILED)
          window.drift.iq.push({ name: e, payload: t })
        else {
      ...
      rt = function getIframeWindowContext() {
        return de(window.drift_iframe_window_context)
          ? window
          : window.drift_iframe_window_context
      },
      ot = new (function IframeModeResizeManager() {
        var e = this
        _classCallCheck(this, IframeModeResizeManager),
          (this._lastOffsetApplied = void 0),
          (this._sendResizeEventForTakeover = function (t) {
            var n = Y[M.TAKEOVER],
              r = Y[M.CONTROLLER]
            qe(r.$div, M.CONTROLLER, t),
              (r.$div.style.bottom = e._lastOffsetApplied.vertical
                ? e._lastOffsetApplied.vertical
                : '12px'),
              (r.$div.style[t] = e._lastOffsetApplied.horizontal
                ? e._lastOffsetApplied.horizontal
                : '12px')
            var o = e._getIframeWrappedStyles(n, t)
            tt(He.IFRAME_RESIZED, { styles: o })
          }),
          (this.checkAndApplyOffsets = function (t, n) {
            ...
            if (
              ...
              (null === Y || void 0 === Y
                ? void 0
                : null === (r = Y.chat) || void 0 === r
                ? void 0
                : null === (o = r.$div) || void 0 === o
                ? void 0
                : null === (i = o.classList) || void 0 === i
                ? void 0
                : i.contains('drift-chat-open'))
            )
              return (t.bottom = 0), void (t[n] = 0)
            e._lastOffsetApplied.vertical &&
              (t.bottom = e._lastOffsetApplied.vertical),
              e._lastOffsetApplied.horizontal &&
                (t[n] = e._lastOffsetApplied.horizontal)
          }),
          (this._sendResizeEventForEmailCapture = function (t) {
            var n = Y[M.EMAIL_CAPTURE],
              r = e._getIframeWrappedStyles(n, t)
            e.checkAndApplyOffsets(r, t), tt(He.IFRAME_RESIZED, { styles: r })
          }),
          (this._sendResizeEventForSlider = function (t) {
            var n = Y[M.CONTROLLER],
              r = Y[M.SLIDER],
              o = e._getIframeWrappedStyles(r, t)
            ;(r.$div.style.bottom = xe),
              (n.$div.style.bottom = xe),
              e.checkAndApplyOffsets(o, t),
              tt(He.IFRAME_RESIZED, { styles: o })
          }),
          (this._sendResizeEventForChat = function (t) {
            ...
            if (n && r) {
              ...
              e.checkAndApplyOffsets(o, t), tt(He.IFRAME_RESIZED, { styles: o })
            }
          }),
          (this._getIframeWrappedChatStyles = function (e, t) {
            ...
            return (
              ...
              (e.style.bottom = '64px'),
              n === U
                ? ((e.style.right = '-12px'), (t.style.right = xe))
                : ((e.style.left = '-12px'), (t.style.left = xe)),
              (t.style.bottom = xe),
              o
            )
          }),
          (this._getIframeWrappedStyles = function (e) {
            ...
            if (e.name === M.TAKEOVER)
              return _objectSpread2(
                _objectSpread2({}, ze(M.TAKEOVER)),
                {},
                { border: 'none' }
              )
            if (e.name === M.EMAIL_CAPTURE) {
              var n = _objectSpread2(
                _objectSpread2({}, ze(M.EMAIL_CAPTURE)),
                {},
                {
          ...
          (this.applyOffset = function () {
            ...
            if (nt()) {
              var o = rt(),
                ...
                a = i.window - i.chat,
                s = ''.concat(t > a ? a : t, 'px')
              tt(He.IFRAME_RESIZED, { styles: _defineProperty({}, r, s) }),
                (e._lastOffsetApplied[n] = s)
            }
          }),
          (this.handleFrameResize = function () {
            if (nt()) {
              var t = Y[M.CONTROLLER],
                n = Ie(t)
              return Y[M.TAKEOVER]
                ? e._sendResizeEventForTakeover(n)
                : Y[M.EMAIL_CAPTURE]
                ? e._sendResizeEventForEmailCapture(n)
                : Y[M.SLIDER]
                ? e._sendResizeEventForSlider(n)
                : e._sendResizeEventForChat(n)
            }
          }),
          (this._lastOffsetApplied = { horizontal: null, vertical: null })
      })(),
      ...
      at = (function () {
        ...
        return (
          (XFind.prototype['@@transducer/init'] = P),
          (XFind.prototype['@@transducer/result'] = function (e) {
            return (
          ...
          (XFind.prototype['@@transducer/step'] = function (e, t) {
            return (
              this.f(t) &&
                ((this.found = !0),
                (e = _reduced(this.xf['@@transducer/step'](e, t)))),
              e
            )
          }),
          XFind
              ...
              var t,
                ...
                o = {
                  innerHeight:
                    null === r || void 0 === r
                      ? void 0
                      : null === (t = r.window) || void 0 === t
                      ? void 0
                      : t.innerHeight,
                  innerWidth:
                    null === r || void 0 === r
                      ? void 0
                      : null === (n = r.window) || void 0 === n
                      ? void 0
                      : n.innerWidth,
    ...
    var ft = [M.EMAIL_CAPTURE, M.SLIDER, M.TAKEOVER],
      ...
      vt = function generateFrame(e) {
        ...
        if (!Y[t]) {
          ...
          if (!w)
            return (
              ce(new Error('Unable to create new iframe element on the DOM')),
              null
            )
          w.setAttribute('class', ''.concat('drift-frame', '-').concat(t)),
            w.setAttribute('scrolling', 'no'),
            w.setAttribute('title', H[t]),
            w.setAttribute('allow', 'autoplay; encrypted-media; fullscreen;'),
            w.setAttribute('frameborder', '0'),
            (function setFrameStyle(e) {
              var t = Te()
              ;(e.style.background = 'transparent'),
                (e.style.width = t ? '1px' : Ee),
                (e.style.maxWidth = Ee),
                (e.style.height = t ? '1px' : Ee),
                (e.style.border = 'none'),
                t && ((e.style.minWidth = Ee), (e.style.minHeight = Ee))
            })(w)
          var y = he(),
            _ = ''
          ;(t !== M.EMAIL_CAPTURE && t !== M.SLIDER && t !== M.TAKEOVER) ||
            (_ = '?isXSScreenSize=' + je()),
            (w.src = ''.concat(y, '/').concat(s).concat(_))
          var b = Gt({
            name: t,
            frame: w,
            height: r,
      ...
      wt = function setOffsetForFrames(e) {
        var t = e.offset,
          n = e.type,
          r = e.affectedStyle,
          o = e.maxOffset,
          ...
          f = Te(),
          l = f
            ? ['controller', 'slider', 'emailCapture']
            : ['controller', 'slider', 'chat', 'emailCapture']
        'string' === typeof t &&
        ((t = t.replace('px', '')), (t = parseFloat(t)), isNaN(t))
          ? se([
              'Unable to apply '.concat(n, ' offset - invalid input ').concat(t)
            ])
          : nt()
          ? ot.applyOffset(t, n, r)
          : it(Y).forEach(function (e) {
              ...
              if (h) {
                var m = (function calcBounds(e) {
                    ...
                    return (
                      u && u[h] && ((p += u[h]), (t += u[h])),
                      { isOffsetBeyondBounds: n, maxAvailableOffset: t }
                    )
                  })(i),
                  g = m.isOffsetBeyondBounds,
                  v = m.maxAvailableOffset,
                  w = (function calcSize(e, t, n, r) {
                    return ''.concat(e ? Math.max(t, n) : r, 'px')
                  })(g, Number(c.style[r].replace('px', '')), v, p)
                'vertical' === n &&
                  (window.drift.offset = Number(w.replace('px', ''))),
                  (c.style[r] = w)
              }
            })
      },
      yt = function setHorizontalOffsetForFrames(e) {
        ...
        wt({
          ...
          affectedStyle: n,
          customOffset: { chat: -12, slider: ye }
        })
      },
      _t = function setVerticalOffsetForFrames(e) {
        var t = e.offset,
          n = document.documentElement.clientHeight < 700 ? 374 : 602
        wt({
          offset: t,
          type: 'vertical',
          maxOffset: 260,
      ...
      bt = function alignFrames(e) {
        ...
        it(Y).forEach(function (e) {
          ...
          ;-1 !== r.indexOf(o) &&
            (t.classList.remove(
              ''.concat('drift-frame', '-').concat(o, '-align-right')
            ),
            t.classList.remove(
              ''.concat('drift-frame', '-').concat(o, '-align-left')
            ),
            t.classList.add(
              ''.concat('drift-frame', '-').concat(o, '-align-').concat(n)
            ))
        })
      },
      Et = function getFrameHeight(e) {
        ...
        return (
          Y[t] ||
            ce(
              new Error(
                'Attempting to get height on an unmounted frame: '.concat(t)
              )
            ),
          Y[t].$div.style.height
        )
      },
      xt = le(function (e) {
        return (function setFrameDimensions(e) {
          ...
          Y[r] ||
            ce(
              new Error(
                'Attempting to set dimensions on an unmounted frame: '.concat(r)
              )
            )
          var o = Y[r],
            i = o.$div,
          ...
          ;(s === t && c === n) ||
            ...
            (a.style.width = n),
            lt())
        })({ height: e.height, width: e.width, name: e.name })
      }, 100),
      ...
      St = function setFrameHeight(e) {
        var t = e.height,
          ...
          c = void 0 === s || s,
          u = e.intent,
          f = void 0 === u ? et.NONE : u
        Y[n] ||
          ce(
            new Error(
              'Attempting to set height on an unmounted frame: '.concat(n)
            )
          )
        var l = Y[n].$div,
          d = c ? l.style.maxHeight : l.style.height,
          p = f === et.SHOW && d !== xe
        if (d !== t && !p) {
          var h = o && a && d !== xe && t !== xe
          At(l, o, 'with-transition'),
            At(l, h, 'with-height-transition'),
            n === M.CONTROLLER &&
              (t = (function getAndPersistHeight(e, t, n) {
                return (
                  e.dataset.prevHeight &&
                    ((t = e.dataset.prevHeight), delete e.dataset.prevHeight),
                  t === xe && (e.dataset.prevHeight = n),
                  t
                )
              })(l, t, d)),
            c
              ? (n === M.CHAT &&
                  l.style.setProperty(
                    'height',
                    Te() || je() ? Ae : 'calc(100% - 75px)',
                    'important'
                  ),
                l.style.setProperty('max-height', t, 'important'))
              : l.style.setProperty('height', t, 'important'),
            lt()
        }
      },
      Ot = function setFrameWidth(e) {
        var t = e.width,
          n = e.name,
          r = e.transition,
          o = void 0 !== r && r
        Y[n] ||
          ce(
            new Error(
              'Attempting to set width on an unmounted frame: '.concat(n)
            )
          )
        var i = Y[n],
          a = i.$div,
        ...
        if (a.style.width !== t)
          return (
            At(a, o, 'with-transition'),
            a.style.setProperty('width', t, 'important'),
            s.style.setProperty('width', t, 'important'),
            a.style.width
          )
      },
      It = (function () {
                  ...
                  case 0:
                    return (
                      ...
                      Y[a] ||
                        ce(
                          new Error(
                            'Attempting to set width and height on an unmounted frame: '.concat(
                              a
                            )
                          )
                        ),
                      ...
                      (d = f.$frame),
                      n && l.classList.add(n),
                      At(l, c, 'with-transition'),
                      r && (o ? (l.style.maxHeight = r) : (l.style.height = r)),
                      u && ((l.style.width = u), (d.style.width = u)),
                      lt(),
                      i.abrupt('return', l)
                    )
                  case 9:
      ...
      kt = function isChatFrameOpen() {
        var e, t, n
        return null === Y || void 0 === Y
          ? void 0
          : null === (e = Y.chat) || void 0 === e
          ? void 0
          : null === (t = e.$div) || void 0 === t
          ? void 0
          : null === (n = t.classList) || void 0 === n
          ? void 0
          : n.contains('drift-chat-open')
      },
      Tt = function setResponsiveChatHeight(e) {
        var t = e || {},
          n = t.name,
          r = void 0 === n ? 'chat' : n,
          o = t.defaultHeight,
          ...
          s = void 0 === a || a
        if (
          !(function isIframeModeAndChatClosed(e) {
            return nt() && 'chat' === e && !kt()
          })(r)
        ) {
          var c = Te() ? Ae : ''.concat(ut(Y.chat, i), 'px')
          St({ height: c, name: r, transition: s })
        }
      },
      Ct = function getWindow() {
        var e
        return (
          (nt() && (null === (e = rt()) || void 0 === e ? void 0 : e.window)) ||
          window
        )
      },
      Pt = function setResponsiveChatWidth(e) {
        var t,
          n = e || {},
          r = n.name,
          o = void 0 === r ? 'chat' : r,
        ...
        ;(t = Te()
          ...
          ? ''.concat(u, 'px')
          : ''.concat(u <= 380 ? u : a, 'px')),
          Ot({ width: t, name: o, transition: c }),
          lt()
      },
      Rt = function waitUntilInnerHeightSettles() {
        return new window.Promise(function (e) {
          !(function step(t, n) {
            window.innerHeight !== n || t >= 120
              ? e()
      ...
      Dt = function toggleResponsiveClassName() {
        var e =
            arguments.length > 0 && void 0 !== arguments[0]
              ? arguments[0]
              : null,
      ...
      Lt = null,
      Ft = function setResponsiveChatDimensions() {
        Pt(), Tt()
      },
      Bt = function startResponsiveSizeListeners(e) {
        function broadcastReflowEvent() {
          Te() ||
            it(Y).forEach(function (t) {
              var n,
                r = t.$div.id.replace('drift-frame-', '')
              r &&
                r !== M.CONTROLLER &&
                (r !== M.CHAT || e) &&
                ee({
        ...
        Wt(),
          (Lt = Object(ct.throttle)(
            200,
            !1,
            (function createSizeChangeEventHandler(e) {
                  ...
                  return i.a.wrap(function _callee2$(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 3:
                          kt &&
                            (Pt({ transition: !1 }), Tt({ transition: !1 })),
                            it(Y).forEach(function (e) {
                              var t = e.$div.id.replace('drift-frame-', '')
                              if ([M.EMAIL_CAPTURE, M.SLIDER].includes(t)) {
                                var n,
                                  r = Ct().innerWidth,
                                  o = be[t.toUpperCase()]
                                if (Te()) o = Ee
                                else if (je()) {
                                  var i = t === M.SLIDER ? '20px' : '0'
                                  ;(o = ''.concat(r, 'px')),
                                    (n = 'calc(100% - '.concat(i, ')'))
                                }
                                o &&
            ...
            })(broadcastReflowEvent)
          )),
          Re(!0)
            ? window.addEventListener('orientationchange', Lt)
            : window.addEventListener('resize', Lt),
          Dt(),
          broadcastReflowEvent()
      },
      Wt = function stopResponsiveSizeListeners() {
        Lt &&
          (window.removeEventListener('orientationchange', Lt),
          window.removeEventListener('resize', Lt),
          (Lt = null))
      },
      Nt = function toggleHasChat() {
        it(Y).forEach(function (e) {
          return e.$div.classList.add('drift-has-chat')
        })
      },
      Mt = function toggleChatOpen(e, t) {
        t &&
          (Te() || je()) &&
          document
            .getElementsByTagName('html')[0]
            .classList[e ? 'add' : 'remove']('drift-widget-parent--chat-open')
        it(Y).forEach(function (t) {
          var n,
            r = t.$div,
              ...
              ? i
                ? ((e.style.opacity = '1'),
                  ...
                  r &&
                    ...
                    (e.style.right = xe),
                    (e.style.left = xe)))
                : r && a && (e.style.display = 'none')
              : i
              ? ((e.style.opacity = '0'), (e.style.visibility = 'hidden'))
              : r && a && (e.style.display = 'block')
          })(r, e),
            o === M.CHAT &&
              (function showOrHideFromScreenReaders(e, t) {
                if (e) t ? gt({ name: e }) : mt({ name: e })
              })(M.CHAT, e),
            e
              ? r.classList.add('drift-chat-open')
              : r.classList.remove('drift-chat-open')
        })
      },
      jt = function destroyContentBox() {
        var e = document.querySelector('.drift-widget-content-box')
        e && document.body && document.body.removeChild(e)
      },
      Ut = function generateContentBox(e) {
        var t = e.type,
          n = void 0 === t ? 'image' : t,
          r = e.media
        jt()
        var o = document.createElement({ image: 'img' }[n])
        ...
        return (
          ...
          i.setAttribute(
            'class',
            'drift-widget-content-box drift-widget-content-box-'.concat(n)
          ),
          i.appendChild(o),
                  ...
                  case 0:
                    return (
                      ...
                      Y.chat ||
                        ce(
                          new Error(
                            'Attempting to remove classes on an unmounted frame: chat'
                          )
                        ),
                      (a = Y.chat.$div).classList.add('hide-frame'),
                      (i.next = 6),
                      oe(o)
                    )
                  case 6:
                    return (
                      n.concat('hide-frame').forEach(function (e) {
      ...
      Gt = function generateParentDivElement(e) {
        var t,
          n = e.name,
          r = e.frame,
          o = e.insertInside,
          ...
          f = e.insertBefore
        return !C(i) && Ht(i)
          ? ((t = document.getElementById(i)).appendChild(r), t)
          : ((t = (function getOrCreateFrameContainer(e, t) {
              var n,
                r = document.getElementsByClassName(
                  'drift-conductor-item '.concat('drift-frame', '-').concat(e)
                )
              return (
                r.length
                  ? (function removeAllChildrenFromElement(e) {
                      for (; e.firstChild; ) e.removeChild(e.firstChild)
                    })((n = r[0]))
                  : ((n = document.createElement('div')).setAttribute(
                      'id',
                      ''.concat('drift-frame', '-').concat(e)
                    ),
                    n.setAttribute(
                      'class',
                      'drift-conductor-item '
                    ...
                    qe(n, e, t)),
                Te() && n.classList.add(''.concat('drift-frame', '--mobile')),
                n
              )
            })(n, u)).appendChild(r),
            Ge(t, s, a, c, n, u),
      ...
      qt = function addDivToParentPage(e, t) {
        t && Y[t]
          ? document.body.insertBefore(e, Y[t].$div)
          : document.body && document.body.appendChild(e)
      },
      Ht = function domElementExistsById(e) {
        ...
        case 'function':
          return null !== n._nativeSet
            ? t
              ...
              : n._nativeSet.has(e)
            : o in n._items
            ? !!_includes(e, n._items[o]) || (t && n._items[o].push(e), !1)
            : (t && (n._items[o] = [e]), !1)
        case 'undefined':
    ...
    var Vt = (function () {
      ...
      Xt = _curry2(function uniqBy(e, t) {
        for (var n, r, o = new Vt(), i = [], a = 0; a < t.length; )
          (n = e((r = t[a]))), o.add(n) && i.push(r), (a += 1)
        return i
      })(Yt)
    function _arity(e, t) {
      switch (e) {
    ...
    var Zt = _curry2(function curryN(e, t) {
        return 1 === e
          ? _curry1(t)
          : _arity(
              e,
              (function _curryN(e, t, n) {
                return function () {
                  for (
                    var r = [], o = 0, i = e, a = 0;
                    ...
                    var s
                    a < t.length &&
                    (!_isPlaceholder(t[a]) || o >= arguments.length)
                      ? (s = t[a])
                      : ((s = arguments[o]), (o += 1)),
                      (r[a] = s),
                      _isPlaceholder(s) || (i -= 1),
                      (a += 1)
                  }
    ...
    var en = _curry2(function bind(e, t) {
    ...
    function _methodReduce(e, t, n, r) {
      return e['@@transducer/result'](n[r](en(e['@@transducer/step'], e), t))
    }
    var tn = 'undefined' !== typeof Symbol ? Symbol.iterator : '@@iterator'
    function _reduce(e, t, n) {
      if (
        ...
        return (function _arrayReduce(e, t, n) {
          for (var r = 0, o = n.length; r < o; ) {
            if (
      ...
      if ('function' === typeof n['fantasy-land/reduce'])
        return _methodReduce(e, t, n, 'fantasy-land/reduce')
      if (null != n[tn]) return _iterableReduce(e, t, n[tn]())
      if ('function' === typeof n.next) return _iterableReduce(e, t, n)
      if ('function' === typeof n.reduce)
        return _methodReduce(e, t, n, 'reduce')
    ...
    var nn = (function () {
        ...
        return (
          (XFilter.prototype['@@transducer/init'] = P),
          (XFilter.prototype['@@transducer/result'] = R),
          (XFilter.prototype['@@transducer/step'] = function (e, t) {
      ...
      on = _curry2(function reject(e, t) {
        return rn(
      ...
      an = _curry2(function (e, t) {
        return on(Jt(_includes)(e), t)
      }),
      sn = _curry2(_includes)
    const cn = ['visitCounts', 'isChatFrameOpen', 'useEnterToSubmit']
    var un,
      fn = function clearDriftSessionStorage() {
        $t.forEach(function (e) {
          return hn.removeItem(e)
        })
      },
      ln = function clearDriftLocalStorage() {
        cn.forEach(function (e) {
          return pn.removeItem(e)
        })
      },
      dn = function storageFactory(e) {
        var t = {},
          n = function isStorageSupported() {
            try {
              return (
                window[e].setItem('support_test', 'true'),
                window[e].removeItem('support_test'),
                !0
              )
            } catch (t) {
              return !1
          ...
          o = function get(o) {
            return n()
              ? JSON.parse(window[e].getItem(r(o)))
              : t.hasOwnProperty(r(o))
              ? t[o]
              : void 0
          },
          i = function set(o, i) {
        ...
        return {
          ...
          getAll: function getAll() {
            return n()
              ? Object.keys(window[e]).map(function (t) {
                  return _defineProperty(
                    {},
                    t.split('DRIFT::')[0],
                    JSON.parse(window[e].getItem(r(t)))
                  )
                })
          ...
          sadd: function sadd(e, t) {
            var n = o(e) || []
            i(e, Xt([].concat(_toConsumableArray(n), [t])))
          },
          srem: function srem(e, t) {
            var n = o(r(e)) || []
            i(e, JSON.stringify(an([t], n)))
          },
      ...
      pn = dn('localStorage'),
      hn = dn('sessionStorage'),
      mn = pn.sadd,
      gn = pn.get,
      vn = pn.set,
      wn = function playAudioTrack(e) {
        e.play().catch(function (e) {
          return se(['Could not play sound', e])
        })
      },
      yn = function isFirstInLineCheck(e) {
        return new Promise(function (t) {
          return (
            window.thisTabID || (window.thisTabID = ie()),
            ('hidden' !== document.visibilityState && e) ||
              mn('openTabs', window.thisTabID),
            setTimeout(function () {
              var e = gn('openTabs'),
      ...
      _n = function shallPlaySoundNotification(e, t) {
        return !(!0 === t && !v(e) && !0 === e)
      },
      bn = (function () {
        var e = _asyncToGenerator(
          i.a.mark(function _callee2(e) {
            var t, r, o, a
            return i.a.wrap(function _callee2$(s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    ;(t = e.chatOpen),
                      (r = e.notificationOnFirstVisitOnly),
                      (o = e.activeConversationId),
                      (a = !isNaN(o)),
                      yn(t).then(
                        (function () {
                          var e = _asyncToGenerator(
                                    ...
                                    switch ((o.prev = o.next)) {
                                      ...
                                      case 3:
                                        ...
                                        return (
                                          ...
                                          n
                                            .e(3)
                                            .then(n.t.bind(null, 382, 7))
                                            .then(function (e) {
                                              ;(un = new Audio(e.default)),
                                                wn(un),
                                                hn.set(
                                                  'NOTIFICATION_PLAYED',
                                                  !0
    ...
    var An,
                  ...
                  switch ((i.prev = i.next)) {
                    case 0:
                      ...
                      return (
                        ...
                        (f =
                          'https://api.company-target.com/api/v2/ip.json?key='
                            .concat(e, '&page=')
                            .concat(s, '&page_title=')
                            .concat(c, '&referrer=')
                            .concat(u)),
                    ...
                    case 24:
                      return (
                        (i.prev = 24),
                        (i.t0 = i.catch(7)),
                        i.t0 instanceof DOMException
                          ? console.log('Demandbase data fetch timed out')
                          : console.log('Error fetching Demandbase:', i.t0),
                        i.abrupt('return', t)
                      )
                    case 28:
                      return i.abrupt('return', t)
      ...
      In = _curry2(
        _checkForMethod('forEach', function forEach(e, t) {
          for (var n = t.length, r = 0; r < n; ) e(t[r]), (r += 1)
          return t
        })
      ),
      kn = function clearAllDriftCookies(e) {
        xn.map(function (t) {
          return we.a.remove(t, { domain: e })
        }),
          xn.map(function (e) {
            return we.a.remove(e)
          })
      },
      Tn = (function () {
        var e = _asyncToGenerator(
                ...
                switch ((i.prev = i.next)) {
                  case 0:
                    return (
                      ...
                      (i.next = 5),
                      On(e.demandbaseToken)
                    )
                  case 5:
                    return (
                      (n = i.sent) && (t.demandbase = n),
                      e.pardotId &&
                        ((r = ''.concat('visitor_id').concat(e.pardotId)),
                        (o = we.a.get(r)) && (t.visitor_id = o)),
                      (a = we.a.get()),
                      (s = {}),
                      (c = I(a) || []),
                      In(function (e) {
                        e.toString().startsWith('visitor_id') &&
                          !e.toString().endsWith('-hash') &&
                          (s[e] = a[e])
                      }, c),
                      (t.PARDOT_ALL_COOKIES = s),
                      i.abrupt('return', t)
                    )
                  case 14:
                  case 'end':
      ...
      Cn = function setDriftCookie(e, t) {
        var n =
          ...
          o = n
        return (
          nt() && r && (o.sameSite = 'none'), (o.secure = r), we.a.set(e, t, o)
        )
      },
      Pn = we.a.getJSON,
      Rn = we.a.remove,
      Dn = function getHostnameCookieDomain() {
      ...
      Fn = function isValidForm(e) {
        return e && e instanceof HTMLFormElement && e.elements
          ? !Un(e).some(function (e) {
              return 'password' === e.type
            }) || (ue('Will not connect to form with password fields.'), !1)
          : (ue('Will not connect to form because form has no fields.'), !1)
      },
      Bn = function getFormValuesByName(e) {
        if (
          (arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {})
            .validate &&
          !Fn(e)
        ...
        return (
          t
            .filter(function isValidFormElement(e) {
      ...
      Wn = function getCollectFormDataValue(e) {
        if (!e) return null
        if ('string' === typeof e) {
          var t = document.querySelector(e)
          if (t && 'FORM' === t.tagName) return Bn(t, { validate: !0 })
        } else if (e.tagName) {
          var n = 'FORM' === e.tagName ? e : e.querySelector('form')
          if (Fn(n) && 'FORM' === n.tagName) return Bn(n, { validate: !0 })
        } else if ('object' === typeof e) return e
        return null
      },
      Nn = function collectFormData(e, t) {
        var n = Wn(e)
        n
          ? window.drift.ready
            ? ee({
                ...
                message: { method: 'collectFormData', args: [n, t] }
              })
            : window.drift.q.push(['collectFormData', e, t])
          : ue('collectFormData: Could not find form nor object with value:', e)
      },
      Mn = function stageFormData(e) {
        var t = Wn(e)
        t
          ? Cn('drift_staged_form_data', t, { domain: Dn() })
          : ue('stageFormData: Could not find form nor object with value:', e)
      },
      jn = function commitFormData(e) {
        var t = Pn('drift_staged_form_data')
        t && (Nn(t, e), Rn('drift_staged_form_data', { domain: Dn() }))
      },
      Un = function toFormElementsArray(e) {
        for (var t = [], n = 0; n < e.elements.length; n++)
          t.push(e.elements[n])
        return t
      },
      zn = function toElementsArray(e) {
        for (var t = [], n = 0; n < e.length; n++) t.push(e[n])
        return t
      },
      Gn = function copyFastlaneSettings(e, t) {
        return {
          campaignId: e,
      ...
      Hn = 'fastlaneTestMode',
      $n = function isValidFastlaneTestModeSettings(e) {
        return (
          'object' === typeof e &&
          'string' ===
            typeof (null === e || void 0 === e ? void 0 : e.formId) &&
          '' !== e.formId.trim() &&
          'string' ===
            typeof (null === e || void 0 === e ? void 0 : e.formType) &&
          Object.values(Ln).includes(e.formType)
        )
      },
      Yn = function broadcastFLTestModeEvent(e) {
        var t = e.event,
          n = e.settings,
          r = e.formSubmissionData
        ae({
          type: 'log',
          data: [Hn, t, n].concat(_toConsumableArray(r ? [r] : []))
        }),
          window.parent.postMessage(
            _objectSpread2(
              _objectSpread2({ event: t, type: Hn }, n),
              r && { formSubmissionData: r }
            ),
            '*'
          )
      },
      Vn = function toFormData(e) {
        var t = new FormData()
      ...
      Xn = (function () {
        var e = _asyncToGenerator(
          i.a.mark(function _callee(e, t, n) {
            var r, o, a
            return i.a.wrap(
              function _callee$(i) {
                for (;;)
                  switch ((i.prev = i.next)) {
                    ...
                    case 9:
                      return (
                        (i.prev = 9),
                        (i.t0 = i.catch(2)),
                        fe('Form data submission error: '.concat(i.t0.message)),
                        i.abrupt('return', !1)
                      )
                    case 13:
      ...
      Zn = function disableFormElements(e) {
        var t = zn(e.getElementsByTagName('button')),
          n = zn(e.getElementsByTagName('input'))
        ;[]
          .concat(_toConsumableArray(t), _toConsumableArray(n))
          .forEach(function (e) {
            return e.setAttribute('disabled', 'true')
          })
      },
      Jn = function connectPlainForm(e, t, n) {
        Fn(e) &&
          e.addEventListener(
            'submit',
            (function () {
              var r = _asyncToGenerator(
                i.a.mark(function _callee2(r) {
                  var o, a
                    ...
                    for (;;)
                      switch ((i.prev = i.next)) {
                        case 0:
                          ...
                          return (
                            ue(
                              'Will not submit form because it has no fields.'
                            ),
                            i.abrupt('return')
                          )
                        case 4:
                        ...
                        case 13:
                          if (
                            ((a = r.target.action), Zn(e), (i.t0 = a), !i.t0)
                          ) {
                            i.next = 20
                            break
                          }
                          return (i.next = 19), Xn(a, o, n)
                        case 19:
                          i.t0 = !i.sent
                        case 20:
                          if (!i.t0) {
      ...
      Kn = function getHubspotFormAPI() {
        var e, t, n
        return (
          (null === (e = window) || void 0 === e ? void 0 : e.HubSpotForms) ||
          (null === (t = window) || void 0 === t
            ? void 0
            : null === (n = t.hubspot) || void 0 === n
            ? void 0
            : n.form.api)
        )
      },
      Qn = function hasHubspotForms() {
        return !!Kn()
      },
      er = function findHubspotForm(e) {
        if (e)
          return (function getHubspotFormById(e) {
            var t,
              n = e.split('_')[1]
            return null === (t = Kn()) || void 0 === t ? void 0 : t.getForm(n)
          })(e)
      },
      tr = function connectHubspotForm(e, t) {
        var n,
          r = Object.assign({}, t)
        e.onFormSubmit(function (e) {
          var t = Bn(e)
          r.testMode && Yn({ event: 'onSubmit', settings: r.testMode }),
            t && (n = t)
        }),
          e.onFormSubmitted(function () {
            ...
            r.stageData ? Mn(n) : Nn(n, _objectSpread2({}, r))
          })
      },
      nr = function hasMarketoForms() {
        return !!window.MktoForms2
      },
      rr = function isMarketoForm(e) {
        return !!e.getFormElem
      },
      or = function findMarketoForm(e) {
        if (e) {
      ...
      ir = function connectMarketoForm(e, t) {
        var n = t || {},
          r = Object.assign({}, n)
        t.testMode &&
          e.onSubmit(function () {
            Yn({ event: 'onSubmit', settings: t.testMode })
          }),
          t.stageData
            ? e.onSubmit(function () {
                Mn(e.vals())
            ...
            : e.onSuccess(function (e, n) {
                return t.testMode
                  ? (Yn({
                    ...
                    !1)
                  : (Nn(e, _objectSpread2({ followupUrl: n }, r)), !1)
              })
      },
      ar = function selectForm(e) {
        ...
        if (!n) {
          ...
          try {
            ...
            return (
              ue(
                'Unable to select form because of browser error:',
                i && i.message
              ),
              null
            )
      ...
      sr = function deriveFormType(e) {
        return nr() && or(e)
          ? Ln.MARKETO
          : Qn() && er(e)
          ? Ln.HUBSPOT
          : (function findBasicForm(e) {
              var t = document.querySelector(e)
              return Fn(t)
            })(e)
          ? Ln.BASIC
                ...
                switch ((i.prev = i.next)) {
                  case 0:
                    return (
                      (n = (t = e || {}).formSelector),
                      (r = t.formType),
                      (o = t.testMode) && Yn({ event: 'start', settings: o }),
                      (a = null !== r && void 0 !== r ? r : sr(n)),
                      (i.next = 5),
                      qn(
                        function () {
                          return ar({ formSelector: n, formType: r })
                        },
                        { delay: 3e3 }
                      )
                    )
                  ...
                  case 10:
                    ...
                    break
                  case 13:
                    return tr(s, e), i.abrupt('return')
                  case 15:
                    if (!nr() || !rr(s)) {
                      i.next = 18
                      break
                    }
                    return ir(s, e), i.abrupt('return')
                  case 18:
                    return i.abrupt('break', 23)
                  case 19:
                  case 21:
                    return Jn(s, e), i.abrupt('return')
                  case 23:
                  case 'end':
                    return i.stop()
                }
    ...
    !(function (e) {
      ...
      (function (e) {
        ;(e.DEFAULT = 'DEFAULT'),
          (e.EAGER = 'EAGER'),
          (e.ON_INTERACTIVE = 'ON_INTERACTIVE')
      })(Sn || (Sn = {}))
    var ur = (function () {
        function XMap(e, t) {
          ;(this.xf = t), (this.f = e)
        ...
        return (
          (XMap.prototype['@@transducer/init'] = P),
          (XMap.prototype['@@transducer/result'] = R),
          (XMap.prototype['@@transducer/step'] = function (e, t) {
      ...
      lr = {
        ...
        emailCapture: {
          ...
          label: function label(e) {
            return e.data.playbookId
              ? 'Playbook ID: '.concat(e.data.playbookId)
              : ''
          },
          nonInteraction: !1
        },
      ...
      dr = function resolveEventLabel(e, t) {
        return lr[e].label ? lr[e].label(t) : ''
      },
      pr = function getUniversalAnalyticsGA() {
    ...
    function configCorrectID(e) {
      var t = (function getListWithGA4Ids(e) {
        ...
        if (e.length > 0)
          for (var n = 0; n < e.length; n++)
            e[n] &&
              e[n].includes('googletagmanager.com/gtag') &&
              e[n].indexOf('G-') > -1 &&
              t.push(e[n].split('?')[1].split('&')[0].split('=')[1])
        return t
      })(
    ...
    var hr = function hasUniversalAnalyticsGA() {
        return null !== pr()
      },
      mr = function hasLegacyGa() {
        return !!(function getLegacyGa() {
          return window._gaq
        })()
      },
      gr = function hasGtag(e) {
      ...
      vr = function getNamespacedHitType(e, t) {
      ...
      wr = function sendUAEvent(e, t, n) {
        pr()(vr(e, 'send'), 'event', {
          eventCategory: 'Drift Widget',
          eventAction: lr[t].action,
          eventLabel: dr(t, n),
          nonInteraction: lr[t].nonInteraction
        })
      },
      yr = function GAPassThrough(e, t, n) {
        var r = n ? n.trim().toUpperCase() : '',
          o = hr(),
          i = gr(r),
          a = mr()
        ;(o || a || i) &&
          ('UA' === r.substring(0, 2) && hr()
            ? wr(r, e, t)
            : i
            ? (function sendGA4Event(e, t, n) {
                var r = {
                  event_category: 'Drift Widget',
                  event_label: dr(t, n),
                  non_interaction: lr[t].nonInteraction
                }
                e && (r.send_to = e), window.gtag('event', lr[t].action, r)
              })(r, e, t)
            : hr()
            ? wr(r, e, t)
            : a &&
              (function sendLegacyEvent(e, t) {
                window._gaq.push([
                  '_trackEvent',
                  'Drift Widget',
                  lr[e].action,
      ...
      _r = function () {
        !(function attachListeners(e) {
          var t = e.trackingName,
            ...
            i = void 0 !== o && o
          Object.keys(lr).forEach(function attachListener(e) {
            ;(i && !r[e]) ||
              (window.drift &&
                window.drift('on', e, function (n) {
                  return yr(e, n, t)
                }))
          })
              ...
              for (;;)
                switch ((c.prev = c.next)) {
                  ...
                  case 8:
                    ...
                    return (c.next = 11), we.a.get(e)
                  case 11:
                    if (((a = c.sent), (s = Date.now() - n), !a)) {
                      c.next = 16
                      break
                    }
                    return we.a.remove(e), c.abrupt('return', a)
                  case 16:
                    s > r && (o = !0), (c.next = 8)
                    break
                  case 19:
    ...
    var Er = new ((function () {
        function PageTitleNotifier() {
          _classCallCheck(this, PageTitleNotifier),
            (this._notificationCount = 0),
            (this._originalPageTitle = void 0),
            (this._blinkInterval = void 0),
            (this._pageTitleNotificationMsg = void 0),
            (this._currentPageTitle = void 0),
            (this._neverUpdatedTitle = !0)
        }
        return (
          (function _createClass(e, t, n) {
                      ...
                      function _callee$(t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              ;(e = '('
                                .concat(this._notificationCount, ') ')
                                .concat(
                                  this._pageTitleNotificationMsg ||
                                    'New Messages',
                                  '!'
                                )),
                                this._setPageTitle(e),
                                (this._currentPageTitle = e),
                                (this._neverUpdatedTitle = !1)
                            case 4:
                            case 'end':
                              return t.stop()
                          }
            ...
            },
            {
              ...
              value: function _clearPageTitle() {
                this._neverUpdatedTitle &&
                  (this._originalPageTitle = this._getPageTitle()),
                  this._setPageTitle(this._originalPageTitle),
            ...
            },
            {
              ...
              value: function _onBlink() {
                ...
                e !== this._currentPageTitle
                  ? (t && (this._originalPageTitle = e),
            ...
            },
            {
              ...
              value: function update(e, t) {
                ;(function isBotCrawler() {
                  ...
                  ((this._notificationCount = e),
                  (this._pageTitleNotificationMsg =
                    null === t || void 0 === t
                      ? void 0
                      : t.pageTitleNotificationMsg),
                  this._notificationCount < 1
                    ? (this._stopUpdateInterval(), this._clearPageTitle())
      ...
      xr = _curry2(function indexOf(e, t) {
        return 'function' !== typeof t.indexOf || _(t)
          ? _indexOf(t, e, 0)
          : t.indexOf(e)
      }),
      Ar = function getUserLocale(e) {
        var t = Or(e)
        return Sr(t)
      },
      Sr = function normalizeLanguage(e) {
        if (!e) return e
        if (-1 === e.indexOf('-') || e.toLowerCase() !== e) return e
        var t = e.split('-')
        return ''.concat(t[0], '-').concat(t[1].toUpperCase())
      },
      Or = function getLanguage(e) {
      ...
      Ir = _curry2(function memoizeWith(e, t) {
        var n = {}
      ...
      kr = function memoizeUntil(e, t) {
        var n = !1
        return Ir(function timeBased() {
          return (
            setTimeout(function () {
              return (n = !0)
            }, t),
      ...
      Tr = {
              ...
              return i.a.wrap(function _callee$(n) {
                for (;;)
                  switch ((n.prev = n.next)) {
                    case 0:
                      return (t = e.data), n.abrupt('return', Ut(t))
                    case 2:
                    case 'end':
                      return n.stop()
                  }
            ...
            r &&
              (function removeMobileFocusLoop() {
                for (
                  ...
                  var a,
                    s = r[o]
                  ;(null !== (a = s.getAttribute('aria-hidden')) && void 0 !== a
                    ? a
                    : null) && s.removeAttribute('aria-hidden'),
                    s.removeAttribute('data-drift-widget-takeover')
                }
              })()
        },
                ...
                if (o) {
                  ...
                  do {
                    for (
                          ...
                          null !==
                            (s =
                              null === (c = document) || void 0 === c
                                ? void 0
                                : null === (u = c.body) || void 0 === u
                                ? void 0
                                : u.childNodes) && void 0 !== s
                            ? s
                            : [],
                        l = 0,
                        d = f.length;
                      ...
                      var p,
                        h = null !== (p = f[l]) && void 0 !== p ? p : null
                      if (h) {
                        var m =
                            -1 !== xr(h.nodeName.toLowerCase(), i) ||
                            !v(j[h.id]),
                          g = h.isEqualNode(o)
                        !m &&
                          !g &&
                          h.setAttribute &&
                          (h.setAttribute('data-drift-widget-takeover', 'true'),
                    ...
                    o !==
                    (null === (a = document) || void 0 === a ? void 0 : a.body)
                  )
                }
              })(i)
        },
              ...
              return i.a.wrap(function _callee4$(n) {
                for (;;)
                  switch ((n.prev = n.next)) {
                    case 0:
                      return (
                        (t = e.data), n.abrupt('return', dt({ name: t.name }))
                      )
                    case 2:
                    case 'end':
                      return n.stop()
        ...
        'get-integration-data': (function () {
          var e = _asyncToGenerator(
            i.a.mark(function _callee5(e) {
              var t
              return i.a.wrap(function _callee5$(n) {
                for (;;)
                  switch ((n.prev = n.next)) {
                    case 0:
                      return (t = e.data), (n.next = 3), Tn(t)
                    case 3:
        ...
        'get-cookie-value': (function () {
          var e = _asyncToGenerator(
            i.a.mark(function _callee6(e) {
              var t
              return i.a.wrap(function _callee6$(n) {
                for (;;)
                  switch ((n.prev = n.next)) {
                    case 0:
                      return (t = e.data), n.abrupt('return', we.a.get(t.name))
                    case 2:
                    case 'end':
                      return n.stop()
                  }
        ...
        'get-host-cookies': (function () {
          var e = _asyncToGenerator(
            i.a.mark(function _callee7() {
              return i.a.wrap(function _callee7$(e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return e.abrupt('return', we.a.get())
                    case 1:
                    case 'end':
                      return e.stop()
                  }
                  ...
                  switch ((i.prev = i.next)) {
                    case 0:
                      return (
                        ...
                        (r = t.method),
                        (o = t.args),
                        (a = 'localStorage' === n ? pn : hn),
                        i.abrupt('return', a[r].apply(a, _toConsumableArray(o)))
                      )
                    case 4:
                    case 'end':
                      return i.stop()
                  ...
                  switch ((o.prev = o.next)) {
                    case 0:
                      return (
                        (t = e.data),
                        (n = t.config),
                        'googleAnalyticsSettings' === (r = t.type) && _r(n),
                        o.abrupt('return', r)
                      )
                    case 4:
                    case 'end':
                  ...
                  switch ((i.prev = i.next)) {
                    case 0:
                      return (
                        ...
                        (r = t.options),
                        (o = void 0 === r ? {} : r),
                        i.abrupt('return', we.a.remove(n, o))
                      )
                    case 3:
                    case 'end':
                      return i.stop()
                ...
                for (;;)
                  switch ((n.prev = n.next)) {
                    case 0:
                      return (
                        (t = e.data),
                        n.abrupt('return', Object.assign(window, {})[t.key])
                      )
                    case 2:
                    case 'end':
                      return n.stop()
                  ...
                  switch ((i.prev = i.next)) {
                    case 0:
                      return (
                        ...
                        (n = rt()),
                        (r = n ? n.window : window),
                        (o = n ? n.document : window.document),
                        (a = kr(function () {
                          return {
                            location: r.location,
                            title: o.title,
                            ...
                            drift_page_view_started:
                              window.drift_page_view_started,
                      ...
                      return (
                        (n = function eventFiredHandler() {
                          var e =
                            ...
                            n = {}
                          t.eventProperties &&
                            t.eventProperties.length &&
                            t.eventProperties.forEach(function (t) {
                              return (n[t] = e[t])
                            }),
                            me(t.handler) && t.handler(n)
                        }),
                        (window.drift_event_listeners[t.id] = n),
                        r.abrupt(
                          'return',
                          document.addEventListener(t.event, n)
                        )
                      )
                    case 6:
                    case 'end':
                    ...
                    case 0:
                      ;(t = e.data),
                        document.removeEventListener(
                          t.event,
                          window.drift_event_listeners[t.id]
                        ),
        ...
        'play-host-notification': (function () {
          var e = _asyncToGenerator(
            i.a.mark(function _callee21(e) {
              var t
              return i.a.wrap(function _callee21$(n) {
                for (;;)
                  switch ((n.prev = n.next)) {
                    case 0:
                      return (t = e.data), n.abrupt('return', bn(t))
                    case 2:
                    case 'end':
                      return n.stop()
                  }
                ...
                for (;;)
                  switch ((n.prev = n.next)) {
                    case 0:
                      if (
                        ((t = e.data),
                        window.drift_display_mode !== An.LANDING_PAGE)
                      ) {
                        n.next = 4
                        break
                      }
        ...
        'reset-controller-size': (function () {
          var e = _asyncToGenerator(
            i.a.mark(function _callee33() {
              return i.a.wrap(function _callee33$(e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      Ot({ width: ''.concat(ye, 'px'), name: 'controller' }),
                        St({
                          height: ''.concat(ye, 'px'),
                          name: 'controller',
                          max: !1
          ...
          t.name === M.CONTROLLER
            ...
            : (function focusFrame(e) {
                ...
                Y[t] ||
                  ce(
                    new Error(
                      'Attempting to get height on an unmounted frame: '.concat(
                        t
                      )
                    )
                  ),
              ...
              return i.a.wrap(function _callee40$(i) {
                for (;;)
                  switch ((i.prev = i.next)) {
                    ...
                    case 7:
                      Bt(n),
                        n ? (r ? Ft() : Pt()) : St({ name: 'chat', height: xe })
                    case 9:
                    case 'end':
                      return i.stop()
                  }
        ...
        'redirect-to-url': function redirectToUrl(e) {
          var t = e.data
          ;(de(t.url) || 0 === t.url.trim().indexOf('javascript:')) &&
            se(['cannot redirect - invalid redirect url specified']),
            (window.location.href = t.url)
        },
        'attach-form-listener-to-dom': (function () {
          var e = _asyncToGenerator(
            i.a.mark(function _callee45(e) {
              var t, n, r
              return i.a.wrap(
                function _callee45$(o) {
                  for (;;)
                    switch ((o.prev = o.next)) {
                      case 0:
                        if (((t = e.data), !$n(t.fastlaneTestModeSettings))) {
                          o.next = 5
                          break
                        }
                        return (
                          ...
                          cr({
                            ...
                            formSelector: '#'.concat(
                              t.fastlaneTestModeSettings.formId
                            ),
                      ...
                      case 7:
                        ...
                        return (
                          (o.prev = 8),
                          (r = Gn(
                            t.fastLaneCampaigns[n].campaignId,
                            t.fastLaneCampaigns[n].fastlaneSettings
                          )),
                          (o.next = 12),
                          cr(r)
                        )
    ...
    var Cr = le(function () {
        var e
        Pe() &&
          (null === (e = window.drift) || void 0 === e ? void 0 : e.ready) &&
          kt() &&
          ee({
            name: 'chat',
            topic: 'parent-scroll',
      ...
      Pr = [
        ...
        { event: 'scroll', handler: le(Cr, 1e3) }
      ],
      Rr = function setupFrameListeners() {
        Object.keys(Tr).forEach(function (e) {
          Q({ topic: e, handler: Tr[e] })
        })
      },
      Dr = function setupHostListeners() {
        Pr.forEach(function (e) {
          ...
          ;('scroll' !== t || Pe()) &&
            ('popstate' !== t ||
            (!De() &&
              !(function isLegacyEdgeBrowser() {
                return /Edge\/\d./i.test(navigator.userAgent)
              })())
              ? window.addEventListener(t, n)
              : (function detectHashChangeOnMicrosoftLegacyBrowser(e) {
                  var t = null
                  window.setInterval(function detectHashChange() {
                    t !== window.location.hash &&
                      ((t = window.location.hash), e())
                  }, 100)
                })(n))
        })
      }
    ...
    var Lr = function IframeFactoryBase(e) {
      var t = this,
        n = e.frameInstructions,
        r = e.frameCreationOptions
      _classCallCheck(this, IframeFactoryBase),
        (this._readyFrames = []),
        (this._readyFrameListeners = {}),
        (this._frameInstructions = []),
        (this._frameCreationOptions = {}),
        (this.initialize = function () {
          t.initializeIframes(), t.attachReadyEvents()
        }),
        (this.unload = function () {
          ;(t._frameInstructions = []),
            (t._readyFrames = []),
            Object.keys(t._readyFrameListeners).forEach(function (e) {
              ...
              r = _defineProperty(
                {
                  ...
                  campaignRefreshToken:
                    t._frameCreationOptions.campaignRefreshToken,
                  hideController: window.drift_display_mode !== An.CHAT,
                  pageLoadStartTime: g(
                    void 0,
                    ['performance', 'timing', 'responseEnd'],
                    window
                  ),
                  mode: g(An.CHAT, ['drift_display_mode'], window),
                  driftEnableLog:
                    t._frameCreationOptions.frameDebugEnabled || !1,
                  loadStrategy: window.drift_init_options
                    ? window.drift_init_options.loadType
                    : null,
                  secureIframe: nt() || !1,
        ...
        (this.setFrameReady = function (e) {
          ;(window.drift[''.concat(e, 'Ready')] = !0),
            -1 === t._readyFrames.indexOf(e) && t._readyFrames.push(e)
        }),
        ...
        (this.assignRegionForFrame = function () {
          return N('-eu', t._frameCreationOptions.embedId.toLowerCase()) ? q : G
        }),
        (this.attachReadyEventForFrame = function (e) {
          var n = ''.concat(e.toUpperCase(), '_READY')
          var r = function onPrivateReadyHandlerFn() {
            this.setFrameReady(e),
              this._frameInstructions.length !== this._readyFrames.length ||
                window.drift.allFramesReady ||
                tt(Je.ALL_FRAMES_READY)
          }.bind(t)
          document.addEventListener(Je[n], r),
            (t._readyFrameListeners[''.concat(Je[n])] = r)
        }),
        (this.attachQueryParamsToFrame = function (e, t) {
          for (var n = '?d=1', r = 0; r < Object.keys(t).length; r++) {
            ...
            void 0 !== t[o] &&
              null !== t[o] &&
              (n = n.concat('&'.concat(o, '=').concat(t[o])))
          }
          return ''.concat(e).concat(n)
        }),
        (this._frameInstructions = n),
        (this._frameCreationOptions = r)
    }
    ...
    var Fr = (function (e) {
      _inherits(ChatFrameFactory, Lr)
      var t = _createSuper2(ChatFrameFactory)
      function ChatFrameFactory(e) {
        var n
        return (
          _classCallCheck(this, ChatFrameFactory),
          (n = t.call(this, {
            frameInstructions: [
              {
                name: M.CONTROLLER,
    ...
    var Br,
      ...
      Mr = function IframeFactory(e) {
        var t = this
        _classCallCheck(this, IframeFactory),
          (this._embedId = void 0),
          (this._sessionId = void 0),
          (this._campaignRefreshToken = void 0),
          (this._frameDebugEnabled = !1),
          (this.generateFramesForMode = function (e, n) {
            var r
            switch (e) {
              case An.CHAT:
                r = new Fr({
          ...
          (this._embedId = e.embedId),
          (this._sessionId = e.sessionId),
          (this._campaignRefreshToken = e.campaignRefreshToken),
          (this._frameDebugEnabled = !!(
            g('', ['location', 'search'], window).indexOf('driftEnableLog') > -1
          ))
      },
      jr = _curry2(function is(e, t) {
      ...
      Ur = (function () {
        ...
        return (
          (XFindIndex.prototype['@@transducer/init'] = P),
          (XFindIndex.prototype['@@transducer/result'] = function (e) {
            return (
          ...
          (XFindIndex.prototype['@@transducer/step'] = function (e, t) {
            return (
              ...
              this.f(t) &&
                ((this.found = !0),
                (e = _reduced(this.xf['@@transducer/step'](e, this.idx)))),
              e
            )
          }),
          XFindIndex
      ...
      zr = _curry2(
        _dispatchable(
          [],
          _curry2(function _xfindIndex(e, t) {
            return new Ur(e, t)
          }),
      ...
      qr = n(10),
      Hr = n.n(qr),
      $r = 'undefined' !== typeof performance && performance,
      Yr =
        $r && $r.now
          ? function () {
              return $r.now()
    ...
    if ($r && $r.mark)
      (Br = function mark(e) {
        throwIfEmpty(e), $r.mark('start ' + e)
      }),
        (Wr = function stop(e) {
          throwIfEmpty(e),
            $r.mark('end ' + e),
            $r.measure(e, 'start ' + e, 'end ' + e)
          var t = $r.getEntriesByName(e)
          return t[t.length - 1]
        }),
        function getEntries() {
          return $r.getEntriesByType('measure')
        },
        function clear() {
          $r.clearMarks(), $r.clearMeasures()
        }
    else {
      var Vr = {},
        Xr = []
          ...
          return (
            (function insertSorted(e, t) {
              for (var n, r = 0, o = e.length; r < o; )
                e[(n = (r + o) >>> 1)].startTime < t.startTime
                  ? (r = n + 1)
                  : (o = n)
              e.splice(r, 0, t)
            })(Xr, r),
    ...
    var Zr = function startTraceMark(e) {
        Br(e)
      },
      Jr = function stopTraceMark(e) {
        try {
      ...
      Kr = function isValidEmbedId(e) {
        return /^[\d\w]{12}(-dev|-eu)?$/gm.test(e)
      },
      Qr = (n(19), ['interactive', 'complete']),
      eo = ['complete'],
      to = Object.freeze({
        configuration: {},
        defer: !1,
      ...
      no = function resolveCampaignRefreshToken() {
        var e = we.a.get('drift_campaign_refresh'),
          t =
            e ||
            (function setCampaignRefreshCookie() {
              var e = ie()
              return (
                Cn('drift_campaign_refresh', e, {
      ...
      ro = function resolveVisitorSession() {
        var e = hn.get('SESSION_STARTED'),
          t = new Date().getTime() / 1e3,
          n = hn.get('SESSION_ID'),
          r = n || ie()
        n || hn.set('SESSION_ID', r),
          e || hn.set('SESSION_STARTED', t),
          (window.drift_page_view_started = t),
          (window.drift_session_started = e || t),
          (window.drift_session_id = r)
      },
      oo = (function () {
        var e = _asyncToGenerator(
          i.a.mark(function _callee(e, t) {
            ...
            return i.a.wrap(function _callee$(r) {
              for (;;)
                switch ((r.prev = r.next)) {
                  case 0:
                    if (
                      (Zr('widget_conductor:init'), (r.t0 = t.defer), !r.t0)
                    ) {
                      r.next = 5
                      break
                    }
                  ...
                  case 5:
                    document.addEventListener('touchstart', function () {}, !0),
                      (window.drift_event_listeners = {}),
                      (window.drift_display_mode = t.mode),
                      (window.drift.embedId = e),
                      no(),
                      ro(),
                      Rr(),
                      Dr(),
                      ...
                      (window.drift_frameFactory = n.generateFramesForMode(
                        t.mode,
                        t
                      )),
                      jr(Object, t.configuration) &&
                        !C(t.configuration) &&
                        lo(t.configuration),
                      Jr('widget_conductor:init')
                  case 17:
                  case 'end':
                    return r.stop()
                }
      ...
      io = function init(e, t) {
        var n = t || {},
          r = window.drift_init_options || {},
          o = _objectSpread2(_objectSpread2({}, n), r),
          i =
            'Please confirm you are using the correct install snippet: https://gethelp.drift.com/s/article/How-To-Install-Drift-Using-Javascript'
        if ('string' === typeof e)
          if (
            e &&
            'undefined' !== e.toLowerCase() &&
            'null' !== e.toLowerCase() &&
            'nan' !== e.toLowerCase()
          )
            if (Kr(e))
              if ('object' === typeof o)
                if (window.drift.hasInitialized)
                  console.warn('Drift has already been initialized.')
                else {
                  var a = _objectSpread2(_objectSpread2({}, to), o)
                  switch (a.loadType) {
                    case Sn.ON_INTERACTIVE:
                      ao(e, a)
                      break
                    case Sn.EAGER:
                      so(Qr, e, a)
              ...
              console.error('Drift init - invalid embedId format. '.concat(i))
          else console.error('Drift init - invalid embedId.  '.concat(i))
        else console.error('Drift init - embedId must be string. '.concat(i))
      },
      ao = function loadWidgetOnConsistentlyInteractive(e, t) {
        Hr.a.getFirstConsistentlyInteractive().then(function () {
          ;(window.drift.hasInitialized = !0), oo(e, t)
        })
      },
      so = function loadWidgetOnReadyStates(e, t, n) {
        if (
          -1 !== e.indexOf(document.readyState) &&
          !window.drift.hasInitialized
        )
          return (window.drift.hasInitialized = !0), void oo(t, n)
        document.addEventListener('readystatechange', function () {
          ;-1 === e.indexOf(document.readyState) ||
            window.drift.hasInitialized ||
            ((window.drift.hasInitialized = !0), oo(t, n))
        })
      },
      co = (function () {
        var e = _asyncToGenerator(
      ...
      uo = function isValidEvent(e, t) {
        return -1 ===
          Object.keys(He)
            .map(function (e) {
              return He[e]
            })
            .indexOf('drift::'.concat(e))
          ? (console.warn('Drift API - Unknown event "'.concat(e, '".')), !1)
          : 'function' === typeof t ||
              (console.error(
                'Drift API - Missing or invalid function for event "'.concat(
                  e,
                  '".'
                )
              ),
      ...
      fo = {},
      lo = function config(e) {
        v(e.iframeMode) || (window.drift_iframe_mode = e.iframeMode),
          window.drift.controllerReady
            ? ee({
                name: 'controller',
                topic: 'trigger-api-event',
                message: { method: 'config', args: [e] }
              })
            : window.drift.q.push(['config', e])
      },
      po = (function asyncApiMethod(e) {
        return function () {
        ...
        (function () {
          var e = _asyncToGenerator(
            i.a.mark(function _callee3(e, t) {
              var n, r, o
              return i.a.wrap(function _callee3$(i) {
                for (;;)
                  switch ((i.prev = i.next)) {
                    ...
                    case 6:
                      return (
                        (r = i.sent),
                        window.drift.q.shift(),
                        t(window.drift.api, r),
                        i.abrupt('return')
                      )
                    case 10:
                      ;(o = function eventListener(e) {
                        var r =
                          !!e && !C(e.detail) ? e.detail : window.drift.api
                        n ? t(window.drift.api, e.detail) : t(r)
                      }),
                        fo[e] || (fo[e] = []),
                        fo[e].push({ eventHandler: t, eventListener: o }),
      ...
      mo = function page(e) {
        window.drift.ready && window.drift.hasInitialized
          ? ee({
              name: 'controller',
              topic: 'trigger-api-event',
              message: { method: 'page', args: [e] }
            })
          : ae({
              type: 'log',
              data: [
                'Page event was sent before ready event was fired, dropping event'
              ]
            })
      },
      go = function identify(e, t) {
        var n =
          arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}
        'string' === typeof e
          ? e && 'undefined' !== e.toString()
            ? 'string' === typeof e && e.length > 191
              ? console.warn(
                  'DRIFT-API - drift.identify userId must be less than 191 characters but instead we got '.concat(
                    e.length,
                    ' characters.'
                  )
                )
              : window.drift.controllerReady
              ? ((t && t.hasProvidedIdentity) ||
                  (yo(e), bo(t), n && n.userJwt && _o(n.userJwt)),
                window.drift.ready ? vo(e, t) : wo(e, t, n))
              : window.drift.q.push(['identify', e, t, n])
            : console.warn(
                'DRIFT-API - drift.identify userId cannot be undefined'
              )
          : console.warn(
              'DRIFT-API - drift.identify userId must be string but instead we got '.concat(
                typeof e,
                '.'
              )
            )
      },
      vo = function _broadcastIdentifyEvent(e, t) {
        ee({
          name: M.CONTROLLER,
          topic: 'trigger-api-event',
          message: { method: 'identify', args: [e, t] }
        })
      },
      wo = function _broadcastIdentityProvided(e, t, n) {
        ee({
          name: M.CONTROLLER,
          topic: 'identity-provided',
          message: { externalId: e, attributes: t, options: n }
        })
      },
      yo = function _broadcastIdentifyProvidedId(e) {
        ee({
          name: 'controller',
          topic: 'identity-provided-id',
          message: { externalId: e }
        })
      },
      _o = function _broadcastIdentifyProvidedJwt(e) {
        ee({
          name: 'controller',
      ...
      bo = function _broadcastIdentifyProvidedEmail(e) {
        e &&
          e.email &&
          ee({
            name: 'controller',
        ...
        !(function _broadcastShowEvent() {
          arguments.length > 0 &&
            ...
            ee({
              name: 'controller',
              topic: 'trigger-api-event',
              message: { method: 'show', args: [] }
            })
        })(!window.drift.ready)
      },
      xo = (function throttledAPICall(e) {
        var t =
          arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 3e4
        return Object(ct.throttle)(t, !0, e)
      })(function () {
        ;(window.drift.ready = !1),
          ee({
            name: 'controller',
            topic: 'trigger-api-event',
            message: { method: 'reset', args: [] }
          })
      }),
      Ao = function hide() {
        !(function _broadcastHideEvent() {
          arguments.length > 0 &&
            ...
            ee({
              name: 'controller',
              topic: 'trigger-api-event',
              message: { method: 'hide', args: [] }
            })
        })(!window.drift.ready)
      },
      So = function setContext(e) {
        Io(e),
          (function setIframeWindowContext(e) {
            window.drift_iframe_window_context = e
          })(e)
      },
      Oo = function getWindowPropertyFromPathOrDefault(e, t, n) {
        var r = g(window[t], ['window', t], e)
        return de(r) ? n : r
      },
      Io = function resizeOnContextResize() {
        var e =
            arguments.length > 0 && void 0 !== arguments[0]
              ? arguments[0]
              : { window: {} },
          t = rt(),
          n = Oo(e, 'innerHeight', window.innerHeight),
          r = Oo(e, 'innerWidth', window.innerWidth),
          o = Oo(t, 'innerHeight', window.innerHeight)
        ;(Oo(t, 'innerWidth', window.innerWidth) !== r || o !== n) &&
          (Pt(), Tt(), de(window.drift.offset) || _t(window.drift.offset))
      },
      ko = (function () {
        var e = _asyncToGenerator(
          i.a.mark(function _callee4() {
            var e
              ...
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    ...
                    return (
                      ae({ data: ['drift.unload: drift is not yet loaded'] }),
                      t.abrupt('return')
                    )
                  case 3:
                    return (t.next = 5), ko()
                  case 5:
                    ;(e = t.sent),
                      window.drift_frameFactory.unload(),
                      Ho(),
                      ht(),
                      kn(null === e || void 0 === e ? void 0 : e.data),
                      ln(),
                      fn(),
                      (window.drift.embedId = void 0),
                      (window.drift.hasInitialized = !1)
                  case 14:
                  case 'end':
                    return t.stop()
                }
      ...
      Po = function areConnectFormParamsValid(e) {
        if (!e) return !0
        var t = !1,
          n = function error() {
          ...
          i = e.formSelector,
          a = e.followupUrl
        r(i, 'string', 'formSelector'),
          r(a, 'string', 'followupUrl'),
          r(o, 'number', 'campaignId')
        var s = Object.keys(
          Gr(
            ['map', 'formSelector', 'followupUrl', 'campaignId', 'stageData'],
            e
          )
        )
        return s.length > 0 && n('Invalid params:', s.join(',')), !t
      },
      Ro = function connectForm(e) {
        Po(e) && cr(e)
      }
    ;(window.__DRIFT_ENV__ = 'PRODUCTION'),
      (window.__DRIFT_BUILD_ID__ = '20230818191937-cd31fc2'),
      (window.__DRIFT_BRANCH__ = 'master')
    var Do = document.currentScript,
      Lo = function generateAutoLoadFromLegacySnippet() {
        var e = null,
          t = function tryGetEmbedIdFromLegacyUrl(e) {
            var t = /include\/[^]+\/(.+).js/.exec(e)
            return t && t[1] ? t[1] : null
          }
        if ((Do && Do.src && (e = t(Do.src)), !e)) {
          var n = document.getElementsByTagName('script')
          Array.from(n).forEach(function (n) {
            var r = n.getAttribute('src')
            if (
              r &&
              (function srcIsLegacy(e) {
                return (
                  e.includes('js.driftt') ||
                  e.includes('js.drifttqa') ||
                  e.includes('js.driftqa.com/include')
                )
              })(r)
            ) {
              var o = (e = t(r)).split(':')
          ...
          i.a.mark(function _callee() {
            ...
            return i.a.wrap(function _callee$(r) {
              for (;;)
                switch ((r.prev = r.next)) {
                  case 0:
                    ;(e = window.drift && window.drift.q ? window.drift.q : []),
                      (!(!window.drift || !window.drift.methods) ||
                        !(!window.driftt || !window.driftt.methods)) &&
                        ((t = window.drift || window.driftt),
                        (n = Lo()),
                        (e = [].concat(
                        ...
                        (window.drift = void 0),
                        (window.driftt = void 0)),
                      (window.drift = function () {
                        ;(window.drift.q = window.drift.q || []).push(
                          arguments
                        ),
                          tt(Je.CLEAR_EVENT_Q)
                      }),
      ...
      Bo = Ir(
        function methodIdentity(e) {
          return Yt(e)
        },
        function (e) {
          return function () {
            for (
              var t = -1 !== Xe.indexOf(e),
                n = arguments.length,
                r = new Array(n),
                o = 0;
              o < n;
              ...
              r[o] = arguments[o]
            window.drift.ready || t
              ? ee({
                  name: 'controller',
                  topic: 'trigger-api-event',
                  message: { method: e, args: r }
                })
              : window.drift.q.push([e].concat(r))
          }
        }
      ),
      Wo = function getApiMethod(e) {
        return r[e] ? r[e] : Bo(e)
      },
      No = function attachMethodsToObject(e, t) {
        e.forEach(function (e) {
          Ve.indexOf(e) >= 0 || t[e] || (t[e] = Wo(e))
        })
      },
      Mo = function attachAPI() {
        ;(window.drift.api = window.drift.api || {}),
          (window.drift.api.sidebar = {
            open: Wo('openChat'),
            close: Wo('hideChat'),
            toggle: Wo('toggleChat')
          }),
          No($e, window.drift.api),
          (window.drift.api.widget = {}),
          No(Ye, window.drift.api.widget),
          (window.drift.load = Wo('init')),
          No(Ze, window.drift)
      },
      jo = function handleQ() {
        var e = function isPreApiReadyMethod(e) {
          ...
          n = t
            ...
            : []
        ;(window.drift.q = _toConsumableArray(n)),
          t &&
            n.forEach(function (t) {
              ...
              if (window.drift.apiReady || e(r)) {
                if ('api' === r)
                  return void (function resolveApiMethodPath(e) {
                    var t,
                      n = []
                    e.forEach(function (e) {
                      'string' === typeof e
                    ...
                    r && 'function' === typeof r
                      ? r(t)
                      : console.warn(
                          'Drift API - unable to find Drift API method for path '.concat(
                            n.join('.')
                          )
                        )
                  })(n)
                var o = Wo(r)
                o && o.apply(void 0, _toConsumableArray(n)),
                  window.drift.q.shift()
              }
            })
      },
      Uo = function handleIQ() {
        de(window.drift.iq) ||
          window.drift.iq.forEach(function (e) {
            tt(e.name, e.payload)
          })
      },
      zo = function setApiReady() {
        ;(window.drift.apiReady = !0), window.drift.allFramesReady && jo()
      },
      Go = (function () {
        var e = _asyncToGenerator(
          i.a.mark(function _callee2() {
            return i.a.wrap(function _callee2$(e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    if (
                      ((window.drift.ready = !0),
                      window.drift.allFramesReady || !window.drift.apiReady)
                    ) {
                      e.next = 3
                      break
                    }
      ...
      qo = function setInitReady() {
        ee({
          ...
          (window.drift.allFramesReady = !0),
          window.drift.apiReady && jo()
      },
      Ho = function resetFramesReady() {
        ;(window.drift.allFramesReady = !1),
          Object.values(M).forEach(function (e) {
            window.drift[''.concat(e, 'Ready')] = !1
          })
      },
      $o = function handleInitDebug(e) {
        ee({
          name: 'controller',
          topic: 'debug-init',
          message: {},
      ...
      Yo = function attachEvents() {
        document.addEventListener(Je.CLEAR_EVENT_Q, jo),
          document.addEventListener(He.API_READY, zo),
          document.addEventListener(He.READY, Go),
          document.addEventListener(Je.ALL_FRAMES_READY, qo),
          document.addEventListener(Je.DEBUG_INIT, $o)
      },
      Vo = function isHeadlessBrowser() {
        try {
          return (
            /headless/i.test(navigator.userAgent) &&
            !/headless=true/i.test(document.location.search)
          )
        } catch (e) {
          return !1
        }
    ...
    !(function polyfillKickoff(e) {
      try {
        ...
        Promise.all([
          n.e(1).then(n.t.bind(null, 383, 7)),
          n.e(2).then(n.t.bind(null, 384, 7))
        ])
          .then(function () {
            e()
          })
              ...
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    ...
                    return (
                      console.debug(
                        'Drift: Skipping Widget since Headless Browser was detected.'
                      ),
                      e.abrupt('return')
                    )
                  case 3:
