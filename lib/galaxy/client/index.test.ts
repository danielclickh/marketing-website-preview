...
describe('GalaxyClient', () => {
  ...
  it('enqueues a galaxy event', () => {
    ...
    expect(event.properties.properties['service']['id']).toEqual('my-service-id');
    ...
    expect(event.properties.properties['page']).toEqual('https://my-current-page');
  });
